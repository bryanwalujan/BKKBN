...
class KelurahanCatinController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('kelurahan.catin.index', compact('catins', 'search'));
    }

    public function create()
    {
        return view('kelurahan.catin.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            Catin::create($data);
            return redirect()->route('kelurahan.catin.index')->with('success', 'Data calon pengantin berhasil ditambahkan.');
        } catch (\Exception $e) {
    ...
    public function edit($id)
    {
        ...
        return view('kelurahan.catin.edit', compact('catin'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $catin->update($data);
            return redirect()->route('kelurahan.catin.index')->with('success', 'Data calon pengantin berhasil diperbarui.');
        } catch (\Exception $e) {
    ...
    public function destroy($id)
    {
        try {
            $catin = Catin::findOrFail($id);
            $catin->delete();
            return redirect()->route('kelurahan.catin.index')->with('success', 'Data calon pengantin berhasil dihapus.');
        } catch (\Exception $e) {
            Log::error('Gagal menghapus data calon pengantin: ' . $e->getMessage(), ['id' => $id]);
            return redirect()->route('kelurahan.catin.index')->with('error', 'Gagal menghapus data calon pengantin: ' . $e->getMessage());
        }
    }
}