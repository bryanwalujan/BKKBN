...
<head>
    ...
    <title>Tambah Data Ibu Hamil - Master Panel</title>
            ...
            <div class="px-8 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Tambah data ibu hamil baru ke dalam sistem</p>
                    </div>
            ...
            <form action="{{ route('ibu_hamil.store') }}" method="POST">
                    ...
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    <input type="text" name="imt" id="imt" value="{{ old('imt') }}" maxlength="255" 
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    <input type="text" name="kadar_hb" id="kadar_hb" value="{{ old('kadar_hb') }}" maxlength="255" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3">
                                    <div class="icon">
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    <input type="text" name="tinggi_fundus_uteri" id="tinggi_fundus_uteri" value="{{ old('tinggi_fundus_uteri') }}" maxlength="255" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3">
                                    <div class="icon">
                                        <i class="fas fa-ruler"></i>
                                    </div>
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    <input type="text" name="lingkar_kepala" id="lingkar_kepala" value="{{ old('lingkar_kepala') }}" maxlength="255" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3">
                                    <div class="icon">
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Masukkan data perkembangan janin</p>
                    </div>
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="input-with-icon">
                                    <input type="text" name="taksiran_berat_janin" id="taksiran_berat_janin" value="{{ old('taksiran_berat_janin') }}" maxlength="255" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3">
                                    <div class="icon">
                                        <i class="fas fa-weight"></i>
                                    </div>
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    <input type="text" name="riwayat_penyakit" id="riwayat_penyakit" value="{{ old('riwayat_penyakit') }}" maxlength="255" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3">
                                    <div class="icon">
