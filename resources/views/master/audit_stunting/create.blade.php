...
<head>
    ...
    <title>Tambah Data Audit Stunting - Master Panel</title>
...
<body class="bg-gray-50 font-sans">
    ...
    <div class="ml-64 min-h-screen">
            ...
            <div class="px-8 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Tambah data audit stunting baru ke dalam sistem</p>
                    </div>
        ...
        <div class="p-8">
            ...
            <form method="POST" action="{{ route('audit_stunting.store') }}" enctype="multipart/form-data">
                @csrf
