    ...
    <div class="ml-64 p-6">
        ...
        <form action="{{ route('aksi_konvergensi.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded shadow">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nama_aksi" id="nama_aksi" value="{{ old('nama_aksi') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                @error('nama_aksi')
                    <span class="text-red-600 text-sm">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="number" name="tahun" id="tahun" value="{{ old('tahun') }}" min="2020" max="2030" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                @error('tahun')
                    <span class="text-red-600 text-sm">{{ $message }}</span>
                @enderror
            </div>
