...
<body class="bg-gray-100">
    ...
    <div class="ml-64 p-6">
        ...
        @endif
        <form action="{{ route('aksi_konvergensi.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            <div>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <div class="mt-2 {{ old('penyakit_menular') == 'ada' ? '' : 'hidden' }}" id="jenis_penyakit_container">
