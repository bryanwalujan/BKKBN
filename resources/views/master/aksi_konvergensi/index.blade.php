...
<head>
    ...
    <title>Aksi Konvergensi - Master Panel</title>
    ...
    <div class="ml-64 min-h-screen">
        ...
        <div class="p-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
                ...
                <a href="{{ route('aksi_konvergensi.create') }}" class="bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-xl shadow-sm p-6 card-hover group cursor-pointer">
            ...
            <div class="bg-white rounded-xl shadow-sm border p-6 mb-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    @if ($search)
                        <a href="{{ route('aksi_konvergensi.index') }}" class="text-sm text-gray-600 hover:text-gray-800 flex items-center">
                ...
                <form action="{{ route('aksi_konvergensi.index') }}" method="GET" class="flex gap-4">
                    <div class="flex-grow">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.delete-btn').on('click', function() {
                ...
                const url = '{{ route("aksi_konvergensi.destroy", ":id") }}'.replace(':id', id);
