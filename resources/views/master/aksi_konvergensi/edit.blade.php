...
<head>
    ...
    <title>Edit Aksi Konvergensi - Master Panel</title>
    ...
    <style>
        ...
        .form-input-icon input, .form-input-icon select, .form-input-icon textarea {
            padding-left: 2.5rem;
        }
...
<body class="bg-gray-50 font-sans">
    ...
    <div class="ml-64 min-h-screen">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-800 flex items-center">
                            ...
                            Edit Aksi Konvergensi
                        </h1>
                        <p class="text-gray-600 mt-1">Edit aksi konvergensi untuk penanganan stunting</p>
                    </div>
        ...
        <div class="p-8">
            ...
            <form action="{{ route('aksi_konvergensi.update', $aksiKonvergensi->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Data pengguna yang mengunggah aksi konvergensi</p>
                    </div>
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label for="created_by" class="block text-sm font-medium text-gray-700 mb-2 flex items-center">
                                    <i class="fas fa-user-circle text-blue-500 mr-2 text-xs"></i>
                                    Diunggah Oleh
                                </label>
                                <div class="form-input-icon">
                                    <input type="text" value="{{ $aksiKonvergensi->createdBy ? $aksiKonvergensi->createdBy->name : '-' }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 bg-gray-50" readonly>
                                    <div class="icon">
                    ...
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="form-input-icon">
                                    <input type="text" name="nama_aksi" id="nama_aksi" value="{{ old('nama_aksi', $aksiKonvergensi->nama_aksi) }}" 
                            ...
                            <div>
                                ...
                                <div class="form-input-icon">
                                    <input type="number" name="tahun" id="tahun" value="{{ old('tahun', $aksiKonvergensi->tahun) }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                            ...
                            <div>
                                ...
                                <div class="form-input-icon">
                                    <input type="text" name="pelaku_aksi" id="pelaku_aksi" value="{{ old('pelaku_aksi', $aksiKonvergensi->pelaku_aksi) }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                            ...
                            <div>
                                ...
                                <div class="form-input-icon">
                                    <input type="datetime-local" name="waktu_pelaksanaan" id="waktu_pelaksanaan" value="{{ old('waktu_pelaksanaan', $aksiKonvergensi->waktu_pelaksanaan ? $aksiKonvergensi->waktu_pelaksanaan->format('Y-m-d\TH:i') : '') }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3">
                                    <div class="icon">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="form-input-icon">
                                    <textarea name="narasi" id="narasi" rows="4"
                                              class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                              placeholder="Masukkan narasi aksi konvergensi">{{ old('narasi', $aksiKonvergensi->narasi) }}</textarea>
                                    <div class="icon">
                        ...
                        <div class="intervensi-grid">
                            ...
                            <div class="bg-green-50 p-4 rounded-lg">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div id="jenis_penyakit_container" class="{{ old('penyakit_menular', $aksiKonvergensi->penyakit_menular) == 'ada' ? '' : 'hidden' }}">
                                        <label for="jenis_penyakit" class="block text-sm font-medium text-gray-700 mb-2">Jenis Penyakit</label>
                                        <input type="text" name="jenis_penyakit" id="jenis_penyakit" value="{{ old('jenis_penyakit', $aksiKonvergensi->jenis_penyakit) }}" 
                                               class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2"
                                               {{ old('penyakit_menular', $aksiKonvergensi->penyakit_menular) == 'ada' ? 'required' : '' }}>
                                    </div>
                                    <div>
                        ...
                        <div>
                            ...
                            @if ($aksiKonvergensi->foto)
                                <div class="mb-4 p-4 bg-gray-50 rounded-lg">
                                    ...
                                    <a href="{{ Storage::url($aksiKonvergensi->foto) }}" target="_blank" 
    ...
    <script>
        $(document).ready(function() {
            ...
            function updateKartuKeluarga() {
                ...
                if (kelurahanId) {
                    $.ajax({
                        url: '{{ route("kartu_keluarga.by-kecamatan-kelurahan", ":kelurahan_id") }}'.replace(':kelurahan_id', kelurahanId),
                        type: 'GET',
                        dataType: 'json',
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            ...
            const initialKecamatanId = '{{ old("kecamatan_id", $aksiKonvergensi->kecamatan_id) }}';
