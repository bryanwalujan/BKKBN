...
<head>
    ...
    <title>Tambah Pendamping Keluarga - Master Panel</title>
...
<body class="bg-gray-50 font-sans">
    ...
    <div class="ml-64 min-h-screen">
            ...
            <div class="px-8 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Tambah data pendamping keluarga baru ke dalam sistem</p>
                    </div>
        ...
        <div class="p-8">
            ...
            <form action="{{ route('pendamping_keluarga.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Tentukan lokasi penugasan pendamping</p>
                    </div>
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
