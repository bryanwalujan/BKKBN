    ...
    <div class="ml-64 p-6 fade-in">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800 mb-2">Tambah <span class="gradient-text">Pendamping Keluarga</span></h1>
                    <p class="text-gray-600">Tambah data pendamping keluarga baru ke dalam sistem CSSR</p>
        ...
        <form action="{{ route('pendamping_keluarga.store') }}" method="POST" enctype="multipart/form-data" id="pendampingForm">
            @csrf
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm mb-8 card-hover">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="flex items-center text-sm text-blue-500">
                        ...
                        <span>Form Tambah Pendamping</span>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function updateKartuKeluarga() {
                ...
                var url = '{{ route("pendamping_keluarga.by-kecamatan-kelurahan") }}';
                var data = {};
