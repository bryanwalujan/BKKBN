    ...
    <div class="ml-64 p-6">
        ...
        <form action="{{ route('pendamping_keluarga.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded shadow">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="peran" id="peran" value="{{ old('peran') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                @error('peran')
                    <span class="text-red-600 text-sm">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="number" name="tahun_bergabung" id="tahun_bergabung" value="{{ old('tahun_bergabung') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
