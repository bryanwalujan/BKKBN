        ...
        <form action="{{ route('pendamping_keluarga.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded shadow">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="tahun_bergabung" id="tahun_bergabung" value="{{ old('tahun_bergabung') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-300" required>
                ...
                <div class="col-span-2">
                    ...
                    <div class="mt-2 space-y-2">
                        <div class="flex items-center">
                            ...
                            <input type="text" name="penyuluhan_frekuensi" id="penyuluhan_frekuensi" value="{{ old('penyuluhan_frekuensi') }}" class="ml-4 block w-1/2 border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-300" placeholder="Frekuensi (misal: 2 kali/minggu)">
                        ...
                        <div class="flex items-center">
                            ...
                            <input type="text" name="rujukan_frekuensi" id="rujukan_frekuensi" value="{{ old('rujukan_frekuensi') }}" class="ml-4 block w-1/2 border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-300" placeholder="Frekuensi (misal: 1 kali/bulan)">
                        ...
                        <div class="flex items-center">
                            ...
                            <input type="text" name="kunjungan_krs_frekuensi" id="kunjungan_krs_frekuensi" value="{{ old('kunjungan_krs_frekuensi') }}" class="ml-4 block w-1/2 border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-300" placeholder="Frekuensi (misal: 3 kali/minggu)">
                        ...
                        <div class="flex items-center">
                            ...
                            <input type="text" name="pendataan_bansos_frekuensi" id="pendataan_bansos_frekuensi" value="{{ old('pendataan_bansos_frekuensi') }}" class="ml-4 block w-1/2 border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-300" placeholder="Frekuensi (misal: 1 kali/bulan)">
                        ...
                        <div class="flex items-center">
                            ...
                            <input type="text" name="pemantauan_kesehatan_frekuensi" id="pemantauan_kesehatan_frekuensi" value="{{ old('pemantauan_kesehatan_frekuensi') }}" class="ml-4 block w-1/2 border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-300" placeholder="Frekuensi (misal: 2 kali/minggu)">
    ...
    <script>
        $(document).ready(function() {
            ...
            if (initialKecamatanId) {
                loadKelurahans(initialKecamatanId, {{ old('kelurahan_id') ?? 'null' }});
            }
