...
<head>
    ...
    <title>Tambah Tentang Kami - CSSR</title>
...
<body class="bg-gray-50">
    ...
    <div class="ml-64 p-6 fade-in">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800 mb-2">Tambah <span class="gradient-text">Tentang Kami</span></h1>
                    <p class="text-gray-600">Tambah konten baru untuk halaman Tentang Kami</p>
        ...
        <form action="{{ route('tentang_kami.store') }}" method="POST" enctype="multipart/form-data" id="tentangKamiForm">
            @csrf
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm mb-8 card-hover">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p class="text-gray-600 text-sm mt-1">Isi informasi lengkap untuk halaman Tentang Kami</p>
                    </div>
                    <div class="flex items-center text-sm text-blue-500">
                        <i class="fas fa-info-circle mr-2"></i>
                        <span>Form Tambah Konten</span>
                    </div>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" name="sub_judul" id="sub_judul" value="{{ old('sub_judul') }}" class="form-input" placeholder="Masukkan sub judul" required>
                            @error('sub_judul')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="judul_utama" id="judul_utama" value="{{ old('judul_utama') }}" class="form-input" placeholder="Masukkan judul utama" required>
                            @error('judul_utama')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <textarea name="paragraf_1" id="paragraf_1" class="form-input" rows="4" placeholder="Masukkan paragraf pertama" required>{{ old('paragraf_1') }}</textarea>
                            @error('paragraf_1')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="paragraf_2" id="paragraf_2" class="form-input" rows="4" placeholder="Masukkan paragraf kedua (opsional)">{{ old('paragraf_2') }}</textarea>
                            @error('paragraf_2')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" name="teks_tombol" id="teks_tombol" value="{{ old('teks_tombol') }}" class="form-input" placeholder="Contoh: Pelajari Lebih Lanjut">
                            @error('teks_tombol')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" name="link_tombol" id="link_tombol" value="{{ old('link_tombol') }}" class="form-input" placeholder="https://example.com">
                            @error('link_tombol')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <div class="photo-upload-area" id="gambarUtamaUploadArea">
                                ...
                                <p class="text-gray-600">Klik untuk memilih gambar utama atau seret dan lepas di sini</p>
                                <p class="text-sm text-gray-500 mt-1">Format: JPG, PNG (Maks. 2MB)</p>
                            </div>
                            
                            <input type="file" name="gambar_utama" id="gambar_utama" class="hidden" accept="image/jpeg,image/jpg,image/png" required>
                            <img id="preview_gambar_utama" class="photo-preview" src="#" alt="Preview Gambar Utama">
                        ...
                        <div class="form-group">
                            ...
                            <div class="photo-upload-area" id="gambarOverlayUploadArea">
                                <i class="fas fa-cloud-upload-alt"></i>
                                <p class="text-gray-600">Klik untuk memilih gambar overlay atau seret dan lepas di sini</p>
                                <p class="text-sm text-gray-500 mt-1">Format: JPG, PNG (Maks. 2MB)</p>
                            </div>
                            
                            <input type="file" name="gambar_overlay" id="gambar_overlay" class="hidden" accept="image/jpeg,image/jpg,image/png">
                            <img id="preview_gambar_overlay" class="photo-preview" src="#" alt="Preview Gambar Overlay">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#gambar_utama').on('change', function(e) {
                if (this.files && this.files[0]) {
                    ...
                    reader.onload = function(e) {
                        ...
                        $('#preview_gambar_utama').show();
                        $('#gambarUtamaUploadArea').hide();
                    }
            ...
            $('#tentangKamiForm').on('submit', function(e) {
                var isValid = true;
