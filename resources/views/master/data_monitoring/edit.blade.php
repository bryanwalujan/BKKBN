...
<head>
    ...
    <title>Edit Data Monitoring - Master Panel</title>
...
<body class="bg-gray-50 font-sans">
    ...
    <div class="ml-64 min-h-screen">
            ...
            <div class="px-8 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Edit data monitoring yang sudah ada dalam sistem</p>
                    </div>
        ...
        <div class="p-8">
            ...
            <form action="{{ route('data_monitoring.update', $dataMonitoring->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-section card-hover">
                    ...
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div id="ibu_id_div" style="display: {{ old('target', $target) == 'Ibu' ? 'block' : 'none' }};">
                            ...
                            <div id="balita_id_div" style="display: {{ old('target', $target) == 'Balita' ? 'block' : 'none' }};">
                    ...
                    <div class="form-section-body">
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="perkembangan_anak" id="perkembangan_anak" rows="3"
                                      ...
                                      placeholder="Masukkan perkembangan anak">{{ old('perkembangan_anak', $dataMonitoring->perkembangan_anak) }}</textarea>
                ...
                <div class="form-section card-hover">
                    ...
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <!-- Frekuensi Kunjungan -->
                            <div id="frekuensi_kunjungan_div" style="display: {{ old('kunjungan_rumah', $dataMonitoring->kunjungan_rumah) == '1' ? 'block' : 'none' }};">
                            ...
                            <!-- Frekuensi PMT -->
                            <div id="frekuensi_pmt_div" style="display: {{ old('pemberian_pmt', $dataMonitoring->pemberian_pmt) == '1' ? 'block' : 'none' }};">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select name="terpapar_rokok" id="terpapar_rokok" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 appearance-none">
                                        <option value="0" {{ old('terpapar_rokok', $dataMonitoring->terpapar_rokok) == '0' ? 'selected' : '' }}>Tidak</option>
                                        <option value="1" {{ old('terpapar_rokok', $dataMonitoring->terpapar_rokok) == '1' ? 'selected' : '' }}>Ya</option>
                                    </select>
                                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                        <i class="fas fa-chevron-down text-gray-400"></i>
                                    </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select name="suplemen_ttd" id="suplemen_ttd" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 appearance-none">
                                        <option value="0" {{ old('suplemen_ttd', $dataMonitoring->suplemen_ttd) == '0' ? 'selected' : '' }}>Tidak</option>
                                        <option value="1" {{ old('suplemen_ttd', $dataMonitoring->suplemen_ttd) == '1' ? 'selected' : '' }}>Ya</option>
                                    </select>
                                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                        <i class="fas fa-chevron-down text-gray-400"></i>
                                    </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select name="rujukan" id="rujukan" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 appearance-none">
                                        <option value="0" {{ old('rujukan', $dataMonitoring->rujukan) == '0' ? 'selected' : '' }}>Tidak</option>
                                        <option value="1" {{ old('rujukan', $dataMonitoring->rujukan) == '1' ? 'selected' : '' }}>Ya</option>
                                    </select>
                                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                        <i class="fas fa-chevron-down text-gray-400"></i>
                                    </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select name="bantuan_sosial" id="bantuan_sosial" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 appearance-none">
                                        <option value="0" {{ old('bantuan_sosial', $dataMonitoring->bantuan_sosial) == '0' ? 'selected' : '' }}>Tidak</option>
                                        <option value="1" {{ old('bantuan_sosial', $dataMonitoring->bantuan_sosial) == '1' ? 'selected' : '' }}>Ya</option>
                                    </select>
                                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                        <i class="fas fa-chevron-down text-gray-400"></i>
                                    </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select name="posyandu_bkb" id="posyandu_bkb" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 appearance-none">
                                        <option value="0" {{ old('posyandu_bkb', $dataMonitoring->posyandu_bkb) == '0' ? 'selected' : '' }}>Tidak</option>
                                        <option value="1" {{ old('posyandu_bkb', $dataMonitoring->posyandu_bkb) == '1' ? 'selected' : '' }}>Ya</option>
                                    </select>
                                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                        <i class="fas fa-chevron-down text-gray-400"></i>
                                    </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select name="kie" id="kie" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 appearance-none">
                                        <option value="0" {{ old('kie', $dataMonitoring->kie) == '0' ? 'selected' : '' }}>Tidak</option>
                                        <option value="1" {{ old('kie', $dataMonitoring->kie) == '1' ? 'selected' : '' }}>Ya</option>
                                    </select>
                                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                        <i class="fas fa-chevron-down text-gray-400"></i>
                                    </div>
                    ...
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="date" name="tanggal_monitoring" id="tanggal_monitoring" value="{{ old('tanggal_monitoring', $dataMonitoring->tanggal_monitoring->format('Y-m-d')) }}" 
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="urutan" id="urutan" value="{{ old('urutan', $dataMonitoring->urutan) }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-10"
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Informasi audit dan dokumentasi stunting</p>
                    </div>
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label for="audit_user_id" class="block text-sm font-medium text-gray-700 mb-2 flex items-center">
                                    <i class="fas fa-user-shield text-blue-500 mr-2 text-xs"></i>
                                    Pengaudit
                                </label>
                                <div class="relative">
                                    <select name="audit_user_id" id="audit_user_id" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 appearance-none">
                            ...
                            <div>
                                <label for="audit_pihak_pengaudit" class="block text-sm font-medium text-gray-700 mb-2 flex items-center">
                                    <i class="fas fa-building text-green-500 mr-2 text-xs"></i>
                                    Pihak Pengaudit
                                </label>
                                <div class="relative">
                                    <input type="text" name="audit_pihak_pengaudit" id="audit_pihak_pengaudit" value="{{ old('audit_pihak_pengaudit', $dataMonitoring->auditStunting->pihak_pengaudit ?? '') }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-10"
                                           placeholder="Masukkan pihak pengaudit">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        ...
                        <div class="mt-6">
                            <label for="audit_foto_dokumentasi" class="block text-sm font-medium text-gray-700 mb-2 flex items-center">
                            ...
                            @if ($dataMonitoring->auditStunting && $dataMonitoring->auditStunting->foto_dokumentasi)
                                <div class="mb-3">
                                    <img src="{{ Storage::url($dataMonitoring->auditStunting->foto_dokumentasi) }}" 
                                         alt="Foto Dokumentasi" 
                                         class="image-preview mb-2">
                                    <p class="text-sm text-gray-600">Foto saat ini</p>
                                </div>
                            @endif
                            <input type="file" name="audit_foto_dokumentasi" id="audit_foto_dokumentasi" 
                                   class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                   accept="image/*">
                        ...
                        <div class="mt-6">
                            <label for="audit_laporan" class="block text-sm font-medium text-gray-700 mb-2 flex items-center">
                                <i class="fas fa-file-alt text-orange-500 mr-2 text-xs"></i>
                                Laporan
                            </label>
                            <textarea name="audit_laporan" id="audit_laporan" rows="3"
                                      class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                      placeholder="Masukkan laporan audit">{{ old('audit_laporan', $dataMonitoring->auditStunting->laporan ?? '') }}</textarea>
                            @error('audit_laporan')
                                <p class="mt-1 text-sm text-red-600 flex items-center">
                                    <i class="fas fa-exclamation-circle mr-1"></i>
                                    {{ $message }}
                        ...
                        <div class="mt-6">
                            <label for="audit_narasi" class="block text-sm font-medium text-gray-700 mb-2 flex items-center">
                                <i class="fas fa-align-left text-blue-500 mr-2 text-xs"></i>
                                Narasi
                            </label>
                            <textarea name="audit_narasi" id="audit_narasi" rows="3"
                                      class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                      placeholder="Masukkan narasi audit">{{ old('audit_narasi', $dataMonitoring->auditStunting->narasi ?? '') }}</textarea>
                            @error('audit_narasi')
                                <p class="mt-1 text-sm text-red-600 flex items-center">
                                    <i class="fas fa-exclamation-circle mr-1"></i>
                                    {{ $message }}
                ...
                <div class="flex items-center justify-between pt-6">
                    ...
                    <div class="flex items-center space-x-3">
                        <button type="reset" 
                                class="flex items-center px-6 py-3 bg-gray-300 hover:bg-gray-400 text-gray-700 font-medium rounded-lg transition-colors">
