...
<head>
    ...
    <title>Data Monitoring - Master Panel</title>
    ...
    <div class="ml-64 min-h-screen">
            ...
            <div class="px-8 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Monitoring dan evaluasi data balita</p>
                    </div>
        ...
        <div class="p-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
                ...
                <a href="{{ route('data_monitoring.create') }}" class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl shadow-sm p-6 card-hover group cursor-pointer">
            ...
            <div class="bg-white rounded-xl shadow-sm border p-6 mb-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    @if ($kecamatan_id || $kelurahan_id || $kategori || $warna_badge)
                        <a href="{{ route('data_monitoring.index') }}" class="text-sm text-gray-600 hover:text-gray-800 flex items-center">
                ...
                <form action="{{ route('data_monitoring.index') }}" method="GET" class="grid grid-cols-1 lg:grid-cols-4 gap-4">
                    <div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($dataMonitorings as $index => $dataMonitoring)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900">{{ $dataMonitoring->user->name ?? '-' }}</div>
                                        <div class="text-xs text-gray-500">
                                            <i class="far fa-clock mr-1"></i>
                                            {{ $dataMonitoring->created_at->format('d/m/Y') }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                        @if ($dataMonitoring->kartuKeluarga)
                                            <a href="{{ route('kartu_keluarga.show', $dataMonitoring->kartuKeluarga->id) }}" 
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center space-x-2">
                                            <a href="{{ route('data_monitoring.edit', $dataMonitoring->id) }}" 
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.delete-btn').on('click', function() {
                ...
                const url = '{{ route("data_monitoring.destroy", ":id") }}'.replace(':id', id);
