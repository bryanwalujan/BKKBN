...
<head>
    ...
    <title>Tambah Carousel - Master Panel</title>
            ...
            <div class="px-8 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Tambah konten carousel baru untuk halaman utama</p>
                    </div>
            ...
            <form action="{{ route('carousel.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Masukkan konten teks untuk carousel</p>
                    </div>
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="sub_heading" id="sub_heading" value="{{ old('sub_heading') }}" 
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <textarea name="deskripsi" id="deskripsi" rows="4"
                                              class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 input-with-icon"
                                              placeholder="Masukkan deskripsi carousel" required>{{ old('deskripsi') }}</textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="text" name="button_1_text" id="button_1_text" value="{{ old('button_1_text') }}" 
                                               class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 input-with-icon"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="url" name="button_1_link" id="button_1_link" value="{{ old('button_1_link') }}" 
                                               class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 input-with-icon"
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="text" name="button_2_text" id="button_2_text" value="{{ old('button_2_text') }}" 
                                               class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 input-with-icon"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="url" name="button_2_link" id="button_2_link" value="{{ old('button_2_link') }}" 
                                               class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 input-with-icon"
                                               placeholder="https://example.com">
                                        <div class="input-icon">
                                            <i class="fas fa-external-link-alt"></i>
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Unggah gambar untuk carousel (opsional)</p>
                    </div>
                    <div class="form-section-body">
                        <div>
                        ...
                        <div id="image-preview" class="mt-4 hidden">
                            ...
                            <div class="border border-gray-200 rounded-lg p-4 bg-gray-50">
                                <img id="preview" class="max-h-64 mx-auto rounded" alt="Preview gambar carousel">
                            </div>
                        </div>
                    </div>
                </div>
