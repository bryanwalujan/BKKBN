...
<head>
    ...
    <title>Tambah Carousel - CSSR</title>
    ...
    <div class="ml-64 p-6 fade-in">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800 mb-2">Tambah <span class="gradient-text">Carousel</span></h1>
                    <p class="text-gray-600">Tambah slide carousel baru untuk halaman utama</p>
        ...
        <form action="{{ route('carousel.store') }}" method="POST" enctype="multipart/form-data" id="carouselForm">
            @csrf
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm mb-8 card-hover">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p class="text-gray-600 text-sm mt-1">Isi informasi untuk slide carousel baru</p>
                    </div>
                    <div class="flex items-center text-sm text-blue-500">
                        <i class="fas fa-images mr-2"></i>
                        <span>Form Tambah Carousel</span>
                    </div>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" name="sub_heading" id="sub_heading" value="{{ old('sub_heading') }}" class="form-input" placeholder="Masukkan sub heading" required>
                            @error('sub_heading')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="heading" id="heading" value="{{ old('heading') }}" class="form-input" placeholder="Masukkan heading utama" required>
                            @error('heading')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="deskripsi" id="deskripsi" class="form-input" rows="4" placeholder="Masukkan deskripsi carousel" required>{{ old('deskripsi') }}</textarea>
                        @error('deskripsi')
                            <div class="error-message">
                                <i class="fas fa-exclamation-circle"></i> {{ $message }}
                            </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" name="button_1_text" id="button_1_text" value="{{ old('button_1_text') }}" class="form-input" placeholder="Contoh: Pelajari Lebih Lanjut">
                            @error('button_1_text')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" name="button_1_link" id="button_1_link" value="{{ old('button_1_link') }}" class="form-input" placeholder="https://example.com">
                            @error('button_1_link')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="button_2_text" id="button_2_text" value="{{ old('button_2_text') }}" class="form-input" placeholder="Contoh: Daftar Sekarang">
                            @error('button_2_text')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" name="button_2_link" id="button_2_link" value="{{ old('button_2_link') }}" class="form-input" placeholder="https://example.com">
                            @error('button_2_link')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                    ...
                    <!-- Preview Tombol -->
                    <div id="buttonPreview" class="mt-4 p-4 bg-gray-50 rounded-lg hidden">
                        <p class="text-sm text-gray-600 mb-2">Preview Tombol:</p>
                        <div id="previewButtons" class="flex flex-wrap gap-2"></div>
                    </div>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="form-group">
                        <label for="gambar" class="form-label">
                            <i class="fas fa-image mr-1 text-blue-500"></i> Gambar Carousel
                        </label>
                ...
                <div class="flex justify-between pt-6 border-t border-gray-200">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Simpan Carousel
                    </button>
                </div>
            </div>
        </form>
