...
<body class="bg-gray-50">
    ...
    <div class="ml-64 p-6 fade-in">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center">
                    <a href="{{ route('balita.index') }}" class="text-blue-500 hover:text-blue-700 mr-4 flex items-center">
        ...
        <form action="{{ route('balita.update', $balita->id) }}" method="POST" enctype="multipart/form-data" id="balitaForm">
            @csrf
            @method('PUT')
                ...
                <div class="mb-8">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="tanggal_lahir" id="tanggal_lahir" value="{{ old('tanggal_lahir', $balita->tanggal_lahir->format('Y-m-d')) }}" class="form-input" required>
                            @error('tanggal_lahir')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.1" name="berat" id="berat" value="{{ old('berat', explode('/', $balita->berat_tinggi)[0]) }}" class="form-input" placeholder="0.0" required>
                            @error('berat')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.1" name="tinggi" id="tinggi" value="{{ old('tinggi', explode('/', $balita->berat_tinggi)[1]) }}" class="form-input" placeholder="0.0" required>
                            @error('tinggi')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                        ...
                        <div class="photo-container">
                            @if ($balita->foto)
                                <div class="photo-section">
                                    ...
                                    <img src="{{ Storage::url($balita->foto) }}" alt="Foto Balita" class="current-photo">
                                </div>
                            @endif
                            
                            <div class="photo-section">
                                <span class="photo-label">Ubah Foto:</span>
