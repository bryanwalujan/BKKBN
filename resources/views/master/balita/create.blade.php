    ...
    <div class="ml-64 p-6">
        ...
        <form action="{{ route('balita.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded shadow">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="alamat" id="alamat" value="{{ old('alamat') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                @error('alamat')
                    <span class="text-red-600 text-sm">{{ $message }}</span>
                @enderror
            </div>
            <div class="mb-4">
                ...
                <input type="text" name="status_gizi" id="status_gizi" value="{{ old('status_gizi', 'Normal') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                @error('status_gizi')
                    <span class="text-red-600 text-sm">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="status_pemantauan" id="status_pemantauan" value="{{ old('status_pemantauan') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
