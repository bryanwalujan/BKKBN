...
<head>
    ...
    <title>Edit Publikasi - CSSR</title>
    ...
    <div class="ml-64 p-6 fade-in">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800 mb-2">Edit <span class="gradient-text">Publikasi</span></h1>
                    <p class="text-gray-600">Edit publikasi yang sudah ada di sistem CSSR</p>
        ...
        <form action="{{ route('publikasi.update', $publikasi->id) }}" method="POST" enctype="multipart/form-data" id="publikasiForm">
            @csrf
            @method('PUT')
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm mb-8 card-hover">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p class="text-gray-600 text-sm mt-1">Edit informasi lengkap publikasi</p>
                    </div>
                    <div class="flex items-center text-sm text-purple-500">
                        <i class="fas fa-edit mr-2"></i>
                        <span>Form Edit Publikasi</span>
                    </div>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" name="judul" id="judul" value="{{ old('judul', $publikasi->judul) }}" class="form-input" placeholder="Masukkan judul publikasi" required>
                            @error('judul')
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="urutan" id="urutan" value="{{ old('urutan', $publikasi->urutan) }}" class="form-input" min="1" required>
                            @error('urutan')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="form-grid">
                        <div class="form-group md:col-span-2">
                            ...
                            <textarea name="deskripsi" id="deskripsi" class="form-input" rows="5" placeholder="Masukkan deskripsi atau isi publikasi" required>{{ old('deskripsi', $publikasi->deskripsi) }}</textarea>
                            @error('deskripsi')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            @if ($publikasi->gambar)
                                <div class="mb-4">
                                    ...
                                    <div class="image-container">
                                        <div>
                                            <img src="{{ asset('storage/' . $publikasi->gambar) }}" alt="Gambar Publikasi" class="current-image">
                                            <div class="image-actions">
                                                <button type="button" class="btn btn-secondary btn-sm" onclick="document.getElementById('gambar').click()">
                            ...
                            <div class="photo-upload-area {{ $publikasi->gambar ? 'hidden' : '' }}" id="photoUploadArea">
                            ...
                            <img id="photoPreview" class="photo-preview hidden" src="#" alt="Preview Gambar">
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" name="link_aksi" id="link_aksi" value="{{ old('link_aksi', $publikasi->link_aksi) }}" class="form-input" placeholder="https://example.com">
                            @error('link_aksi')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="teks_tombol" id="teks_tombol" value="{{ old('teks_tombol', $publikasi->teks_tombol) }}" class="form-input" placeholder="Baca Selengkapnya" maxlength="50" required>
                            @error('teks_tombol')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
            ...
            $('#gambar').on('change', function(e) {
                if (this.files && this.files[0]) {
                    ...
                    reader.onload = function(e) {
                        ...
                        $('.current-image').parent().hide(); // Sembunyikan gambar lama jika ada
                    }
