...
<head>
    ...
    <title>Tambah Layanan Kami - Master Panel</title>
...
<body class="bg-gray-50 font-sans">
    ...
    <div class="ml-64 min-h-screen">
            ...
            <div class="px-8 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Tambah layanan baru ke dalam sistem</p>
                    </div>
        ...
        <div class="p-8">
            ...
            <form action="{{ route('layanan_kami.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Masukkan informasi dasar tentang layanan</p>
                    </div>
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="judul_layanan" id="judul_layanan" value="{{ old('judul_layanan') }}" 
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <textarea name="deskripsi_singkat" id="deskripsi_singkat" rows="3"
                                              ...
                                              maxlength="500" placeholder="Masukkan deskripsi singkat layanan" required>{{ old('deskripsi_singkat') }}</textarea>
                                </div>
                                <div id="counter-singkat" class="character-counter">
                                    <span id="count-singkat">0</span>/500 karakter
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <textarea name="deskripsi_lengkap" id="deskripsi_lengkap" rows="5"
                                              class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                              placeholder="Masukkan deskripsi lengkap layanan">{{ old('deskripsi_lengkap') }}</textarea>
                                </div>
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Unggah ikon dan atur pengaturan layanan</p>
                    </div>
                    <div class="form-section-body">
                                ...
                                <div class="flex items-center space-x-4">
                                    <div class="flex-1">
                                        <input type="file" name="ikon" id="ikon" 
                                               class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                               accept="image/jpeg,image/jpg,image/png" onchange="previewImage(this, 'preview_ikon')" required>
                                    ...
                                    <div class="flex-shrink-0">
                                        <div class="w-16 h-16 bg-gray-100 rounded-lg flex items-center justify-center overflow-hidden border">
                                            <img id="preview_ikon" class="w-full h-full object-cover hidden">
