...
<head>
    ...
    <title>Edit Layanan Kami - CSSR</title>
    ...
    <div class="ml-64 p-6 fade-in">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800 mb-2">Edit <span class="gradient-text">Layanan Kami</span></h1>
                    <p class="text-gray-600">Edit informasi layanan yang akan ditampilkan di halaman utama</p>
        ...
        <form action="{{ route('layanan_kami.update', $layananKami->id) }}" method="POST" enctype="multipart/form-data" id="layananForm">
            @csrf
            @method('PUT')
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm mb-8 card-hover">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p class="text-gray-600 text-sm mt-1">Edit informasi lengkap tentang layanan</p>
                    </div>
                ...
                <div class="info-box">
                    <p>
                        ...
                        Perbarui informasi layanan sesuai dengan kebutuhan terbaru.
                    </p>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" name="judul_layanan" id="judul_layanan" value="{{ old('judul_layanan', $layananKami->judul_layanan) }}" class="form-input" placeholder="Masukkan judul layanan" required>
                            @error('judul_layanan')
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="urutan" id="urutan" value="{{ old('urutan', $layananKami->urutan) }}" class="form-input" min="1" required>
                            @error('urutan')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi_singkat" id="deskripsi_singkat" class="form-input" rows="3" placeholder="Masukkan deskripsi singkat layanan" maxlength="500" required>{{ old('deskripsi_singkat', $layananKami->deskripsi_singkat) }}</textarea>
                            <div id="counter-singkat" class="character-counter">{{ strlen(old('deskripsi_singkat', $layananKami->deskripsi_singkat)) }}/500 karakter</div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi_lengkap" id="deskripsi_lengkap" class="form-input" rows="5" placeholder="Masukkan deskripsi lengkap layanan (opsional)">{{ old('deskripsi_lengkap', $layananKami->deskripsi_lengkap) }}</textarea>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <div class="current-icon">
                            <img src="{{ asset('storage/' . $layananKami->ikon) }}" alt="Ikon Saat Ini" id="currentIcon">
                            <span class="current-icon-label">Ikon saat ini</span>
                        </div>
                        
                        <div class="photo-upload-area" id="photoUploadArea">
                            <i class="fas fa-cloud-upload-alt"></i>
                            <p class="text-gray-600">Klik untuk memilih ikon baru atau seret dan lepas di sini</p>
                            <p class="text-sm text-gray-500 mt-1">Rekomendasi: 64x64 px untuk tampilan optimal</p>
                        </div>
                        
                        <input type="file" name="ikon" id="ikon" class="hidden" accept="image/jpeg,image/jpg,image/png">
                        <img id="photoPreview" class="photo-preview hidden" src="#" alt="Preview Ikon Baru">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        <div class="checkbox-container">
                            <div class="custom-checkbox {{ old('status_aktif', $layananKami->status_aktif) ? 'checked' : '' }}" id="customCheckbox">
                                <input type="checkbox" name="status_aktif" id="status_aktif" class="hidden" {{ old('status_aktif', $layananKami->status_aktif) ? 'checked' : '' }}>
                            </div>
