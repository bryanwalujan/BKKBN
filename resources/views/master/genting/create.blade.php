...
<head>
    ...
    <title>Tambah Kegiatan Genting - Master Panel</title>
...
<body class="bg-gray-50 font-sans">
    ...
    <div class="ml-64 min-h-screen">
            ...
            <div class="px-8 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Tambah kegiatan genting baru ke dalam sistem</p>
                    </div>
        ...
        <div class="p-8">
            ...
            <form action="{{ route('genting.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Masukkan informasi dasar tentang kegiatan genting</p>
                    </div>
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="jenis_intervensi" id="jenis_intervensi" value="{{ old('jenis_intervensi') }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-10"
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Masukkan narasi dan dokumentasi kegiatan</p>
                    </div>
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <textarea name="narasi" id="narasi" rows="5"
                                          ...
                                          placeholder="Masukkan narasi lengkap tentang kegiatan">{{ old('narasi') }}</textarea>
                                @error('narasi')
                                    <p class="mt-1 text-sm text-red-600 flex items-center">
                                        <i class="fas fa-exclamation-circle mr-1"></i>
                                        {{ $message }}
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Tentukan pihak-pihak yang terlibat dalam kegiatan</p>
                    </div>
                    <div class="form-section-body">
