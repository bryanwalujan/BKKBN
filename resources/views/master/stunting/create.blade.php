...
<head>
    ...
    <title>Tambah Data Stunting - CSSR</title>
...
<body class="bg-gray-50">
    ...
    <div class="ml-64 p-6 fade-in">
        ...
        @else
            ...
            <form action="{{ route('stunting.store') }}" method="POST" enctype="multipart/form-data" id="stuntingForm">
                @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            function populateReview() {
                ...
                if (file) {
                    $('#reviewFoto').text('Gambar telah diunggah');
