...
<head>
    ...
    <title>Tambah Data Stunting - Master Panel</title>
...
<body class="bg-gray-50 font-sans">
    ...
    <div class="ml-64 min-h-screen">
        ...
        <div class="p-8">
            ...
            <form action="{{ route('stunting.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="flex items-center justify-between pt-6">
                    ...
                    <button type="submit" 
                            class="flex items-center px-6 py-3 bg-red-500 hover:bg-red-600 text-white font-medium rounded-lg transition-colors card-hover">
