...
<head>
    ...
    <script>
        $(document).ready(function() {
            ...
            var initialKecamatanId = '{{ $stunting->kecamatan_id }}';
            var initialKelurahanId = '{{ $stunting->kelurahan_id }}';
    ...
    <div class="ml-64 p-6">
        ...
        <form action="{{ route('stunting.update', $stunting->id) }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded shadow">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nik" id="nik" value="{{ $stunting->nik }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" pattern="[0-9]+" inputmode="numeric" title="NIK hanya boleh berisi angka">
                @error('nik')
                    <span class="text-red-600 text-sm">{{ $message }}</span>
                @enderror
            </div>
            <div class="mb-4">
                ...
                <input type="text" name="nama" id="nama" value="{{ $stunting->nama }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                @error('nama')
                    <span class="text-red-600 text-sm">{{ $message }}</span>
                @enderror
            </div>
            <div class="mb-4">
                ...
                <input type="date" name="tanggal_lahir" id="tanggal_lahir" value="{{ $stunting->tanggal_lahir->format('Y-m-d') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                @error('tanggal_lahir')
                    <span class="text-red-600 text-sm">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="number" name="berat" id="berat" value="{{ explode('/', $stunting->berat_tinggi)[0] }}" step="0.1" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                @error('berat')
                    <span class="text-red-600 text-sm">{{ $message }}</span>
                @enderror
            </div>
            <div class="mb-4">
                ...
                <input type="number" name="tinggi" id="tinggi" value="{{ explode('/', $stunting->berat_tinggi)[1] }}" step="0.1" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                @error('tinggi')
                    <span class="text-red-600 text-sm">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="tindak_lanjut" id="tindak_lanjut" value="{{ $stunting->tindak_lanjut }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                @error('tindak_lanjut')
                    <span class="text-red-600 text-sm">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                @if ($stunting->foto)
                    <img src="{{ Storage::url($stunting->foto) }}" alt="Foto {{ $stunting->nama }}" class="mt-2 w-32 h-32 object-cover rounded">
                @endif
                @error('foto')
                    <span class="text-red-600 text-sm">{{ $message }}</span>
                @enderror
