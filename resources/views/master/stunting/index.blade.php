...
<head>
    ...
    <title>Data Stunting - Master Panel</title>
...
<body class="bg-gray-50 font-sans">
            ...
            <div class="px-8 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Manajemen data stunting dan monitoring gizi anak</p>
                    </div>
        ...
        <div class="p-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
                <div class="bg-white rounded-xl shadow-sm border p-6 card-hover">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-gray-800 mt-1">{{ $stuntings->total() }}</p>
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border p-6 card-hover">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-gray-600">Status Gizi Waspada</p>
                            <p class="text-2xl font-bold text-gray-800 mt-1">{{ $stuntings->where('warna_gizi', 'Waspada')->count() }}</p>
                        </div>
                ...
                <a href="{{ route('stunting.create') }}" class="bg-gradient-to-r from-red-500 to-red-600 rounded-xl shadow-sm p-6 card-hover group cursor-pointer">
            ...
            <div class="bg-white rounded-xl shadow-sm border p-6 mb-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    @if ($kategoriUmur || $search)
                        <a href="{{ route('stunting.index') }}" class="text-sm text-gray-600 hover:text-gray-800 flex items-center">
                ...
                <form action="{{ route('stunting.index') }}" method="GET" class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                    <div>
                        ...
                        <div class="mt-2 flex flex-wrap gap-2">
                            @if ($kategoriUmur)
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                    ...
                                    <button onclick="removeFilter('kategori_umur')" class="ml-1 hover:text-blue-600">
                                        <i class="fas fa-times"></i>
                                    </button>
                                </span>
                            @endif
                ...
                <div class="px-6 py-4 border-b bg-gray-50">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm text-gray-500">
                            ...
                            Menampilkan {{ $stuntings->count() }} dari {{ $stuntings->total() }} data
                        </div>
                    </div>
                </div>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4">
                                        @if ($stunting->foto)
                                            <div class="relative group">
                                                <img src="{{ Storage::url($stunting->foto) }}" 
                                                     alt="Foto {{ $stunting->nama }}" 
                                                     class="w-16 h-16 object-cover rounded-lg shadow-sm cursor-pointer"
                                                     onclick="showImageModal('{{ Storage::url($stunting->foto) }}', '{{ $stunting->nama }}')">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <button type="button" 
                                                    onclick="showDeleteModal('{{ route('stunting.destroy', $stunting->id) }}', '{{ $stunting->nama }}')"
    ...
    <script>
        ...
        function showImageModal(imageSrc, name) {
            document.getElementById('modalImage').src = imageSrc;
            document.getElementById('imageModalTitle').textContent = 'Foto: ' + name;
