...
<head>
    ...
    <title>Tambah Program - CSSR</title>
    ...
    <div class="ml-64 p-6 fade-in">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800 mb-2">Tambah <span class="gradient-text">Program</span></h1>
                    <p class="text-gray-600">Tambah program baru ke dalam sistem CSSR</p>
        ...
        <form action="{{ route('galeri_program.store') }}" method="POST" enctype="multipart/form-data" id="programForm">
            @csrf
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm mb-8 card-hover">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p class="text-gray-600 text-sm mt-1">Isi informasi lengkap program</p>
                    </div>
                ...
                <div class="info-box">
                    <p>
                        ...
                        Pastikan data program yang dimasukkan akurat dan lengkap untuk informasi yang optimal.
                    </p>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="form-group">
                        ...
                        <img id="preview_gambar" class="photo-preview" src="#" alt="Preview Gambar">
                ...
                <div class="mb-8">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" name="judul" id="judul" value="{{ old('judul') }}" class="form-input" placeholder="Masukkan judul program" required>
                            @error('judul')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="kategori" id="kategori" class="form-input" required>
                                <option value="Penyuluhan" {{ old('kategori') == 'Penyuluhan' ? 'selected' : '' }}>
                                    Penyuluhan
                                </option>
                                <option value="Posyandu" {{ old('kategori') == 'Posyandu' ? 'selected' : '' }}>
                                    Posyandu
                                </option>
                                <option value="Pendampingan" {{ old('kategori') == 'Pendampingan' ? 'selected' : '' }}>
                                    Pendampingan
                                </option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" name="link" id="link" value="{{ old('link') }}" class="form-input" placeholder="https://example.com">
                            @error('link')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="deskripsi" id="deskripsi" class="form-input" rows="5" placeholder="Masukkan deskripsi lengkap program" required>{{ old('deskripsi') }}</textarea>
                        @error('deskripsi')
                            <div class="error-message">
                                <i class="fas fa-exclamation-circle"></i> {{ $message }}
                            </div>
