...
<body class="bg-gray-100">
    ...
    <div class="ml-64 p-6">
        ...
        <form action="{{ route('ibu_menyusui.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded shadow">
            @csrf
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <select name="status_menyusui" id="status_menyusui" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                    <option value="" {{ old('status_menyusui') == '' ? 'selected' : '' }}>-- Pilih Status Menyusui --</option>
