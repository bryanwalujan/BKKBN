...
<head>
    ...
    <title>Tambah Data Ibu Menyusui - CSSR</title>
    ...
    <div class="ml-64 p-6 fade-in">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800 mb-2">Tambah <span class="gradient-text">Data Ibu Menyusui</span></h1>
                    <p class="text-gray-600">Tambah data menyusui baru ke dalam sistem CSSR</p>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm mb-8 card-hover">
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h3 class="text-xl font-semibold text-gray-800">Form Data Ibu Menyusui</h3>
                    <p class="text-gray-600 text-sm mt-1">Isi informasi data menyusui dengan lengkap dan benar</p>
                </div>
            ...
            <form action="{{ route('ibu_menyusui.store') }}" method="POST" id="ibuMenyusuiForm">
                @csrf
                
                <div class="info-box">
                    <p>
                        <i class="fas fa-info-circle"></i> 
                        Pastikan data yang dimasukkan sudah sesuai dengan kondisi ibu menyusui.
                    </p>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="number-input-container">
                                ...
                                <input type="number" name="frekuensi_menyusui" id="frekuensi_menyusui" value="{{ old('frekuensi_menyusui', 0) }}" min="0" max="24" class="form-input number-input" required>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="text" name="kondisi_ibu" id="kondisi_ibu" value="{{ old('kondisi_ibu') }}" class="form-input" required>
                            </div>
                            @error('kondisi_ibu')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
