    ...
    <div class="ml-64 p-6 fade-in">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800 mb-2">Edit <span class="gradient-text">Materi Edukasi</span></h1>
                    <p class="text-gray-600">Edit materi edukasi untuk pencegahan stunting</p>
        ...
        <form method="POST" action="{{ route('edukasi.update', $edukasi->id) }}" enctype="multipart/form-data" id="edukasiForm">
            @csrf
            @method('PUT')
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm mb-8 card-hover">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p class="text-gray-600 text-sm mt-1">Edit informasi lengkap materi edukasi</p>
                    </div>
                    <div class="flex items-center text-sm text-blue-500">
                        <i class="fas fa-edit mr-2"></i>
                        <span>Form Edit Edukasi</span>
                    </div>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="form-grid">
                        <div class="form-group md:col-span-2">
                            ...
                            <input type="text" name="judul" id="judul" value="{{ old('judul', $edukasi->judul) }}" class="form-input" placeholder="Masukkan judul edukasi" required>
                            @error('judul')
                ...
                <div class="mb-8" id="additional-fields">
                    ...
                    <div class="form-grid">
                        <div class="form-group md:col-span-2">
                            ...
                            <textarea name="deskripsi" id="deskripsi" rows="4" class="form-input" placeholder="Masukkan deskripsi edukasi">{{ old('deskripsi', $edukasi->deskripsi) }}</textarea>
                            @error('deskripsi')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" name="tautan" id="tautan" value="{{ old('tautan', $edukasi->tautan) }}" class="form-input" placeholder="https://example.com">
                            @error('tautan')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            @if ($edukasi->gambar)
                                <div class="mb-4">
                                    ...
                                    <img src="{{ Storage::url($edukasi->gambar) }}" alt="Gambar Edukasi" class="photo-preview">
                                </div>
                            @endif
                            ...
                            <img id="photoPreview" class="photo-preview" src="#" alt="Preview Gambar" style="display: none;">
                        ...
                        <div class="form-group">
                            ...
                            @if ($edukasi->file)
                                <div class="current-file">
                                    ...
                                    <span>File saat ini: <a href="{{ Storage::url($edukasi->file) }}" target="_blank" class="hover:underline">Lihat file</a></span>
                                </div>
                            @endif
