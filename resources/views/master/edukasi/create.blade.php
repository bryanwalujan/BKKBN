...
<head>
    ...
    <title>Tambah Edukasi - Master Panel</title>
            ...
            <div class="px-8 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Tambah materi edukasi baru untuk stunting</p>
                    </div>
            ...
            <form method="POST" action="{{ route('edukasi.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Masukkan judul dan kategori materi edukasi</p>
                    </div>
                ...
                <!-- Konten Edukasi -->
                <div class="form-section card-hover" id="additional-fields">
                    <div class="form-section-header">
                        <h2 class="text-lg font-semibold text-gray-800 flex items-center">
                            <i class="fas fa-file-alt text-green-500 mr-2"></i>
                            Konten Edukasi
                        </h2>
                        <p class="text-sm text-gray-600 mt-1">Tambahkan deskripsi, tautan, dan file pendukung</p>
                    </div>
                    <div class="form-section-body">
                        <div class="space-y-6">
                            <div>
                                ...
                                <textarea name="deskripsi" id="deskripsi" rows="4" 
                                          ...
                                          placeholder="Masukkan deskripsi lengkap tentang materi edukasi">{{ old('deskripsi') }}</textarea>
                                @error('deskripsi')
                                    <p class="mt-1 text-sm text-red-600 flex items-center">
                                        <i class="fas fa-exclamation-circle mr-1"></i>
                                        {{ $message }}
                            ...
                            <div>
                                ...
                                <div class="file-input-wrapper">
                                    <div class="file-input-custom">
                                        ...
                                        <span class="text-gray-700" id="file-name">Pilih file PDF atau Word</span>
                                    </div>
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Tambahkan gambar dan atur status publikasi</p>
                    </div>
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="file-input-wrapper">
                                    <div class="file-input-custom">
                                        <i class="fas fa-cloud-upload-alt text-blue-500"></i>
                                        <span class="text-gray-700" id="gambar-name">Pilih gambar (JPG, JPEG, PNG)</span>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#file').on('change', function() {
                ...
                $('#file-name').text(fileName || 'Pilih file PDF atau Word');
            });

            $('#gambar').on('change', function() {
                const fileName = $(this).val().split('\\').pop();
                $('#gambar-name').text(fileName || 'Pilih gambar (JPG, JPEG, PNG)');
            });
        });
    </script>
</body>
