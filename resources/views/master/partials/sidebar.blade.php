        ...
        <ul class="space-y-2 px-3">
            ...
            <li>
                <button class="flex items-center justify-between w-full p-3 rounded-lg transition-all duration-200 group 
                              {{ Route::is('ibu.*', 'balita.*', 'stunting.*', 'ibu_hamil.*', 'ibu_nifas.*', 'ibu_menyusui.*', 'remaja_putri.*', 'kartu_keluarga.*') ? 'bg-white/20 text-white' : 'hover:bg-white/10 text-white/90 hover:text-white' }}"
                    ...
                    <svg id="perdataan-arrow" class="w-4 h-4 transition-transform duration-200 
                        {{ Route::is('ibu.*', 'balita.*', 'stunting.*', 'ibu_hamil.*', 'ibu_nifas.*', 'ibu_menyusui.*', 'remaja_putri.*', 'kartu_keluarga.*') ? 'rotate-180' : '' }}" 
                ...
                <ul id="perdataan-dropdown" class="ml-8 mt-2 space-y-1 
                    ...
                    <li>
                        <a href="{{ route('remaja_putri.index') }}" 
                           class="flex items-center space-x-3 p-2 rounded-lg transition-all duration-200 group 
                                  {{ Route::is('remaja_putri.*') ? 'bg-green-500 text-white shadow-md' : 'hover:bg-white/5 text-white/80 hover:text-white' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
