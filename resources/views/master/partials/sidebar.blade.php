<aside class="w-64 bg-blue-800 text-white h-screen fixed top-0 left-0">
    ...
    <nav class="mt-4">
        <ul>
                ...
                <ul id="perdataan-dropdown"
                    ...
                    <li>
                        <a href="{{ route('stunting.index') }}"
                            class="block p-4 hover:bg-blue-600 {{ Route::is('stunting.*') ? 'bg-blue-600' : '' }}">Data
                            Stunting</a>
                    </li>
                    <li>
                        <a href="{{ route('ibu_hamil.index') }}"
                            class="block p-4 hover:bg-blue-600 {{ Route::is('ibu_hamil.*') ? 'bg-blue-600' : '' }}">Data
                            Ibu Hamil</a>
                    </li>
                    <li>
                        <a href="{{ route('ibu_nifas.index') }}"
                            class="block p-4 hover:bg-blue-600 {{ Route::is('ibu_nifas.*') ? 'bg-blue-600' : '' }}">Data
                            Ibu Nifas</a>
                    </li>
                    <li>
                        <a href="{{ route('ibu_menyusui.index') }}"
                            class="block p-4 hover:bg-blue-600 {{ Route::is('ibu_menyusui.*') ? 'bg-blue-600' : '' }}">Data
                            Ibu Menyusui</a>
                    </li>
                    <li>
                        <a href="{{ route('remaja_putri.index') }}"
                            class="block p-4 hover:bg-blue-600 {{ Route::is('remaja_putri.*') ? 'bg-blue-600' : '' }}">Data
                            Remaja Putri</a>
                    </li>
                    <li class="mb-4">
                ...
                <ul id="kelola-kegiatan-dropdown"
                    ...
                    <li>
                        <a href="{{ route('aksi_konvergensi.index') }}"
                            class="block p-4 hover:bg-blue-600 {{ Route::is('aksi_konvergensi.*') ? 'bg-blue-600' : '' }}">Aksi
                            Konvergensi</a>
                    </li>
                    <li>
                        <a href="{{ route('peta_geospasial.index') }}"
                            class="block p-4 hover:bg-blue-600 {{ Route::is('peta_geospasial.*') ? 'bg-blue-600' : '' }}">Peta
                            Geospasial</a>
                    </li>
                    <li>
                ...
                <ul id="kelola-beranda-dropdown"
                    ...
                    <li>
                        <a href="{{ route('data_riset.index') }}"
                            class="block p-4 hover:bg-blue-600 {{ Route::is('data_riset.*') ? 'bg-blue-600' : '' }}">Data
                            Riset</a>
                    </li>
                    <li>
                        <a href="{{ route('tentang_kami.index') }}"
                            class="block p-4 hover:bg-blue-600 {{ Route::is('tentang_kami.*') ? 'bg-blue-600' : '' }}">Tentang
                            Kami</a>
                    </li>
                    <li>
                        <a href="{{ route('layanan_kami.index') }}"
                            class="block p-4 hover:bg-blue-600 {{ Route::is('layanan_kami.*') ? 'bg-blue-600' : '' }}">Layanan
                            Kami</a>
                    </li>
                    <li>
            ...
            <li>
                <button
                    class="block w-full text-left p-4 hover:bg-blue-700 {{ Route::is('verifikasi.*', 'templates.*', 'users.*') ? 'bg-blue-700' : '' }}"
                ...
                <ul id="kelola-akun-dropdown"
                    class="ml-4 {{ Route::is('verifikasi.*', 'templates.*', 'users.*') ? '' : 'hidden' }}">
                    <li>
                        <a href="{{ route('verifikasi.index') }}"
                            class="block p-4 hover:bg-blue-600 {{ Route::is('verifikasi.*') ? 'bg-blue-600' : '' }}">Verifikasi
                            Akun</a>
                    </li>
                    <li>
                        <a href="{{ route('templates.index') }}"
                            class="block p-4 hover:bg-blue-600 {{ Route::is('templates.*') ? 'bg-blue-600' : '' }}">Kelola
                            Template</a>
                    </li>
                    <li>
                        <a href="{{ route('users.index') }}"
                            class="block p-4 hover:bg-blue-600 {{ Route::is('users.*') ? 'bg-blue-600' : '' }}">Kelola
                            Pengguna</a>
                    </li>
                </ul>
            </li>
                ...
                <ul id="lainnya-dropdown"
                    ...
                    <li>
                        <a href="{{ route('data_penduduk.index') }}"
                            class="block p-4 hover:bg-blue-600 {{ Route::is('data_penduduk.*') ? 'bg-blue-600' : '' }}">Data
                            Penduduk</a>
                    </li>
                </ul>
            </li>
