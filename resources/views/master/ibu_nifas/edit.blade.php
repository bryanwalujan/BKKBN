...
<head>
    ...
    <title>Edit Data Ibu Nifas - CSSR</title>
    ...
    <div class="ml-64 p-6 fade-in">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-gray-600">Perbarui data nifas yang sudah ada dalam sistem CSSR</p>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm mb-8 card-hover">
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h3 class="text-xl font-semibold text-gray-800">Form Edit Data Ibu Nifas</h3>
                    <p class="text-gray-600 text-sm mt-1">Perbarui informasi data nifas dengan lengkap dan benar</p>
                </div>
                <div class="flex items-center text-sm text-pink-500">
                    <i class="fas fa-edit mr-2"></i>
                    <span>Edit Data Nifas</span>
                </div>
            </div>
            ...
            <div class="data-highlight">
                <p>
                    ...
                    Anda sedang mengedit data nifas untuk ibu <strong>{{ $ibuNifas->ibu->nama ?? 'Data Ibu' }}</strong> yang dibuat pada <strong>{{ \Carbon\Carbon::parse($ibuNifas->created_at)->translatedFormat('d F Y') }}</strong>.
                </p>
            </div>
            
            <form action="{{ route('ibu_nifas.update', $ibuNifas->id) }}" method="POST" id="ibuNifasForm">
                @csrf
                @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="number-input-container">
                                ...
                                <input type="number" name="hari_nifas" id="hari_nifas" value="{{ old('hari_nifas', $ibuNifas->hari_nifas) }}" min="0" max="42" class="form-input number-input" required>
                        ...
                        <div>
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="text" name="kondisi_kesehatan" id="kondisi_kesehatan" value="{{ old('kondisi_kesehatan', $ibuNifas->kondisi_kesehatan) }}" class="form-input" placeholder="Contoh: Kondisi stabil, tekanan darah normal" required>
                            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="number-input-container">
                                ...
                                <input type="number" name="berat" id="berat" value="{{ old('berat', $ibuNifas->berat) }}" step="0.1" class="form-input number-input" required>
                        ...
                        <div>
                            ...
                            <div class="number-input-container">
                                ...
                                <input type="number" name="tinggi" id="tinggi" value="{{ old('tinggi', $ibuNifas->tinggi) }}" step="0.1" class="form-input number-input" required>
                        ...
                        <div>
                            ...
                            <div class="input-with-icon">
                                ...
                                <select name="warna_kondisi" id="warna_kondisi" class="form-input" required>
                                    <option value="" {{ old('warna_kondisi', $ibuNifas->warna_kondisi) == '' ? 'selected' : '' }}>-- Pilih Warna Kondisi --</option>
                                    <option value="Hijau (success)" {{ old('warna_kondisi', $ibuNifas->warna_kondisi) == 'Hijau (success)' ? 'selected' : '' }}>Hijau (Kondisi Baik)</option>
                                    <option value="Kuning (warning)" {{ old('warna_kondisi', $ibuNifas->warna_kondisi) == 'Kuning (warning)' ? 'selected' : '' }}>Kuning (Perlu Perhatian)</option>
                                    <option value="Merah (danger)" {{ old('warna_kondisi', $ibuNifas->warna_kondisi) == 'Merah (danger)' ? 'selected' : '' }}>Merah (Kondisi Kritis)</option>
                                </select>
                            </div>
                            @error('warna_kondisi')
                                <div class="error-message">
