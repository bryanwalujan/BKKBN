...
<head>
    ...
    <title>Edit Data Ibu Nifas - Master Panel</title>
...
<body class="bg-gray-50 font-sans">
    ...
    <div class="ml-64 min-h-screen">
            ...
            <div class="px-8 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Edit data ibu nifas yang sudah ada dalam sistem</p>
                    </div>
        ...
        <div class="p-8">
            ...
            <form action="{{ route('ibu_nifas.update', $ibuNifas->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="form-section-body">
                        <div>
                            ...
                            <select name="ibu_id" id="ibu_id" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3" required>
                                ...
                                @foreach ($ibus as $ibu)
                                    <option value="{{ $ibu->id }}" {{ $ibuNifas->ibu_id == $ibu->id ? 'selected' : '' }}>
                                        {{ $ibu->nama }} ({{ $ibu->nik ?? '-' }})
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="hari_nifas" id="hari_nifas" value="{{ $ibuNifas->hari_nifas }}" 
                                           min="0" max="42" step="1"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="date" name="tanggal_melahirkan" id="tanggal_melahirkan" value="{{ old('tanggal_melahirkan', $ibuNifas->tanggal_melahirkan) }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-10">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="tempat_persalinan" id="tempat_persalinan" value="{{ $ibuNifas->tempat_persalinan ?? '' }}" 
                                           maxlength="255"
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-10"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="penolong_persalinan" id="penolong_persalinan" value="{{ $ibuNifas->penolong_persalinan ?? '' }}" 
                                           maxlength="255"
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-10"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="cara_persalinan" id="cara_persalinan" value="{{ $ibuNifas->cara_persalinan ?? '' }}" 
                                           maxlength="255"
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-10"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="komplikasi" id="komplikasi" value="{{ $ibuNifas->komplikasi ?? '' }}" 
                                           maxlength="255"
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-10"
                    ...
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="kb_pasca_salin" id="kb_pasca_salin" value="{{ $ibuNifas->kb_pasca_salin ?? '' }}" 
                                           maxlength="255"
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-10"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="berat" id="berat" value="{{ $ibuNifas->berat }}" 
                                           step="0.1" min="0"
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-10"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="tinggi" id="tinggi" value="{{ $ibuNifas->tinggi }}" 
                                           step="0.1" min="0"
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-10"
                                           placeholder="0.0" required>
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    ...
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="keadaan_bayi" id="keadaan_bayi" value="{{ $ibuNifas->keadaan_bayi ?? '' }}" 
                                           maxlength="255"
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-10"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="bayi[umur_dalam_kandungan]" id="bayi_umur_dalam_kandungan" value="{{ $ibuNifas->bayiBaruLahir->umur_dalam_kandungan ?? '' }}" 
                                           maxlength="255"
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-10"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="bayi[berat_badan_lahir]" id="bayi_berat_badan_lahir" value="{{ $ibuNifas->bayiBaruLahir->berat_badan_lahir ?? '' }}" 
                                           maxlength="255"
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-10"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="bayi[panjang_badan_lahir]" id="bayi_panjang_badan_lahir" value="{{ $ibuNifas->bayiBaruLahir->panjang_badan_lahir ?? '' }}" 
                                           maxlength="255"
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-10"
                ...
                <div class="flex items-center justify-between pt-6">
                    ...
                    <div class="flex space-x-3">
                        <button type="button" 
                                onclick="window.location.href='{{ route('ibu_nifas.index') }}'" 
                                class="flex items-center px-6 py-3 bg-gray-500 hover:bg-gray-600 text-white font-medium rounded-lg transition-colors">
