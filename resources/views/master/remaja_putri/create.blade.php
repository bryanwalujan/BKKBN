...
<head>
    ...
    <title>Tambah Data Remaja Putri - CSSR</title>
...
<body class="bg-gray-50">
    ...
    <div class="ml-64 p-6 fade-in">
        ...
        @else
            <form action="{{ route('remaja_putri.store') }}" method="POST" enctype="multipart/form-data" id="remajaPutriForm">
                @csrf
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm mb-8 card-hover">
                    ...
                    <div class="section-header">
                        <div>
                            <h3 class="section-title">
                                <i class="fas fa-user-graduate text-purple-500"></i> Data Remaja Putri
                            </h3>
                            <p class="section-subtitle">Isi informasi lengkap remaja putri</p>
                        </div>
                    ...
                    <div class="info-box">
                        <p>
                            ...
                            Pastikan data yang dimasukkan akurat dan sesuai dengan dokumen resmi.
                        </p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="umur" id="umur" value="{{ old('umur') }}" min="10" max="19" class="form-input" placeholder="Masukkan umur (10-19)" required>
                            @error('umur')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                        ...
                        <div class="md:col-span-2">
                            <label class="form-label">
                                <i class="fas fa-camera mr-1 text-purple-500"></i> Foto
                            </label>
                            ...
                            <div class="preview-container" id="previewContainer">
                                <p class="text-sm text-gray-600 mb-2">Pratinjau foto:</p>
