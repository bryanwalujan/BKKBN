...
<head>
    ...
    <title>Edit Kartu Keluarga - Master Panel</title>
            ...
            <div class="px-8 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Perbarui data kartu keluarga yang sudah ada dalam sistem</p>
                    </div>
                ...
                <div class="bg-red-50 border border-red-200 rounded-xl p-6 mb-6">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-red-700 mt-1">Silakan tambahkan Kecamatan terlebih dahulu sebelum mengedit Kartu Keluarga.</p>
                        </div>
                    </div>
                </div>
            @else
                <form action="{{ route('kartu_keluarga.update', $kartuKeluarga->id) }}" method="POST">
                    ...
                    <div class="form-section card-hover">
                        <div class="form-section-header">
                            ...
                            <p class="text-sm text-gray-600 mt-1">Perbarui informasi dasar kartu keluarga</p>
                        </div>
                        <div class="form-section-body">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="number" name="no_kk" id="no_kk" value="{{ old('no_kk', $kartuKeluarga->no_kk) }}" 
                                               class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-10 input-focus"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="text" name="kepala_keluarga" id="kepala_keluarga" value="{{ old('kepala_keluarga', $kartuKeluarga->kepala_keluarga) }}" 
                                               class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-10 input-focus"
                    ...
                    <div class="form-section card-hover">
                        <div class="form-section-header">
                            ...
                            <p class="text-sm text-gray-600 mt-1">Perbarui lokasi tempat tinggal keluarga</p>
                        </div>
                        <div class="form-section-body">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <select name="kecamatan_id" id="kecamatan_id" 
                                                class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 appearance-none input-focus"
                                                onchange="updateKelurahan(this.value)" required>
                                            <option value="">-- Pilih Kecamatan --</option>
                                            @foreach ($kecamatans as $kecamatan)
                                                <option value="{{ $kecamatan->id }}" {{ old('kecamatan_id', $kartuKeluarga->kecamatan_id) == $kecamatan->id ? 'selected' : '' }}>
                                    ...
                                    <div class="relative">
                                        <select name="kelurahan_id" id="kelurahan_id" 
                                            ...
                                            @foreach ($kelurahans as $kelurahan)
                                                <option value="{{ $kelurahan->id }}" {{ old('kelurahan_id', $kartuKeluarga->kelurahan_id) == $kelurahan->id ? 'selected' : '' }}>
                            ...
                            <div class="mb-6">
                                ...
                                <div class="relative">
                                    <textarea name="alamat" id="alamat" rows="3"
                                              class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 input-focus"
                                              placeholder="Masukkan alamat lengkap">{{ old('alamat', $kartuKeluarga->alamat) }}</textarea>
                                </div>
                                @error('alamat')
                                    <p class="mt-1 text-sm text-red-600 flex items-center">
                                        <i class="fas fa-exclamation-circle mr-1"></i>
                    ...
                    <div class="form-section card-hover">
                        <div class="form-section-header">
                            ...
                            <p class="text-sm text-gray-600 mt-1">Klik pada peta untuk memperbarui koordinat lokasi rumah</p>
                        </div>
                        <div class="form-section-body">
                            <div class="mb-4">
                                <div id="map"></div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="number" step="any" name="latitude" id="latitude" value="{{ old('latitude', $kartuKeluarga->latitude) }}" 
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="number" step="any" name="longitude" id="longitude" value="{{ old('longitude', $kartuKeluarga->longitude) }}" 
                                               class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-10 bg-gray-50"
                                               required readonly>
                                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    ...
                    <div class="form-section card-hover">
                        <div class="form-section-header">
                            ...
                            <p class="text-sm text-gray-600 mt-1">Perbarui status kartu keluarga</p>
                        </div>
                        <div class="form-section-body">
                            <div class="max-w-md">
    ...
    <script>
        ...
        if (oldLat && oldLng) {
            marker = L.marker([oldLat, oldLng]).addTo(map)
                .bindPopup('<div class="text-center"><i class="fas fa-home text-blue-500"></i><br>Lokasi Rumah Saat Ini</div>')
                .openPopup();
        ...
        map.on('click', function(e) {
            ...
            marker = L.marker([lat, lng]).addTo(map)
                .bindPopup('<div class="text-center"><i class="fas fa-home text-blue-500"></i><br>Lokasi Rumah Baru</div>')
                .openPopup();
        ...
        function updateKelurahan(kecamatanId) {
            ...
            fetch(`/kelurahans/by-kecamatan/${kecamatanId}`)
                ...
                .then(data => {
                    ...
                    const oldKelurahanId = '{{ old("kelurahan_id", $kartuKeluarga->kelurahan_id) }}';
                    if (oldKelurahanId) {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const initialKecamatanId = '{{ old("kecamatan_id", $kartuKeluarga->kecamatan_id) }}';
