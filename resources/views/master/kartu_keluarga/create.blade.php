...
<head>
    ...
    <title>Tambah Kartu Keluarga - CSSR</title>
...
<body class="bg-gray-50">
    ...
    <div class="ml-64 p-6 fade-in">
        ...
        @else
            ...
            <form action="{{ route('kartu_keluarga.store') }}" method="POST" id="kkForm">
                @csrf
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-sm mb-8 card-hover">
                        <div class="flex justify-between items-center mb-6">
                            <div>
                                ...
                                <p class="text-gray-600 text-sm mt-1">Isi informasi dasar kartu keluarga</p>
                            </div>
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-sm mb-8 card-hover">
                        <div class="flex justify-between items-center mb-6">
                            <div>
                                ...
                                <p class="text-gray-600 text-sm mt-1">Tentukan lokasi rumah pada peta</p>
                            </div>
                            <div class="flex items-center text-sm text-blue-500">
    ...
    <script>
        ...
        function initMap() {
            ...
            // Initialize map with Tomohon coordinates
            map = L.map('map').setView([1.319779, 124.838332], 13);
            ...
            // Restore old coordinates if available
        ...
        function updateKelurahan(kecamatanId) {
            ...
            fetch(`/kelurahans/by-kecamatan/${kecamatanId}`)
                ...
                .then(data => {
                    ...
                    // Restore old kelurahan if available
