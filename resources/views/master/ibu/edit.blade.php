...
<head>
    ...
    <title>Edit Data Ibu - Master Panel</title>
...
<body class="bg-gray-50 font-sans">
    ...
    <div class="ml-64 min-h-screen">
        ...
        <div class="p-8">
            ...
            <form action="{{ route('ibu.update', $ibu->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="nik" id="nik" value="{{ $ibu->nik }}" 
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="nama" id="nama" value="{{ $ibu->nama }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-10"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="tempat_lahir" id="tempat_lahir" value="{{ $ibu->tempat_lahir }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-10"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="nomor_telepon" id="nomor_telepon" value="{{ $ibu->nomor_telepon }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-10"
                    ...
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="jumlah_anak" id="jumlah_anak" value="{{ $ibu->jumlah_anak }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-10"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <textarea name="alamat" id="alamat" rows="3"
                                          ...
                                          placeholder="Masukkan alamat lengkap ibu">{{ $ibu->alamat }}</textarea>
                                @error('alamat')
                                    <p class="mt-1 text-sm text-red-600 flex items-center">
                                        <i class="fas fa-exclamation-circle mr-1"></i>
                                        {{ $message }}
                            ...
                            <div>
                                ...
                                @if ($ibu->foto)
                                    <div class="mt-3">
                                        ...
                                        <img src="{{ Storage::url($ibu->foto) }}" alt="Foto {{ $ibu->nama }}" class="photo-preview">
                                    </div>
                                @endif
                                @error('foto')
                                    <p class="mt-1 text-sm text-red-600 flex items-center">
            ...
            $('#foto').on('change', function(e) {
                ...
                if (file) {
                    ...
                    reader.onload = function(e) {
                        ...
                        $('#foto').after('<div class="mt-3"><p class="text-sm text-gray-600 mb-2">Preview Foto Baru:</p><img src="' + e.target.result + '" class="photo-preview"></div>');
                    }
