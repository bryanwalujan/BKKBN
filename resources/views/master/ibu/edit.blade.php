...
<head>
    ...
    <title>Edit Data Ibu - CSSR</title>
    ...
    <div class="ml-64 p-6 fade-in">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800 mb-2">Edit <span class="gradient-text">Data Ibu</span></h1>
                    <p class="text-gray-600">Perbarui data ibu dalam sistem CSSR</p>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm mb-8 card-hover">
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h3 class="text-xl font-semibold text-gray-800">Form Edit Data Ibu</h3>
                    <p class="text-gray-600 text-sm mt-1">Perbarui informasi data ibu dengan lengkap dan benar</p>
                </div>
            ...
            <form action="{{ route('ibu.update', $ibu->id) }}" method="POST" enctype="multipart/form-data" id="ibuForm">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nik" id="nik" value="{{ old('nik', $ibu->nik) }}" class="form-input" placeholder="Masukkan NIK">
                            @error('nik')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="nama" id="nama" value="{{ old('nama', $ibu->nama) }}" class="form-input" placeholder="Masukkan nama lengkap" required>
                            @error('nama')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                        ...
                        <div>
                            ...
                            <textarea name="alamat" id="alamat" class="form-input" rows="3" placeholder="Masukkan alamat lengkap">{{ old('alamat', $ibu->alamat) }}</textarea>
                            @error('alamat')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                        ...
                        <div>
                            <label class="current-photo-label">
                                <i class="fas fa-image mr-1 text-pink-500"></i> Foto Saat Ini
                            </label>
                            <div class="photo-container">
                                @if ($ibu->foto)
                                    ...
                                    <div class="photo-info">
                                        ...
                                        <p class="text-xs text-gray-500">Unggah foto baru untuk mengganti foto saat ini.</p>
                                    </div>
                                @else
                                    <div class="photo-info">
                            ...
                            <label for="foto" class="form-label">
                                <i class="fas fa-camera mr-1 text-pink-500"></i> Foto Baru (Opsional)
                            </label>
                            <div class="file-input-container">
                                ...
                                <label for="foto" class="file-input-label" id="fileInputLabel">
                                    ...
                                    <span>Pilih file foto baru atau seret ke sini</span>
                                </label>
                            </div>
        ...
        $(document).ready(function() {
            ...
            $('#foto').on('change', function() {
                ...
                if (fileName) {
                    ...
                    $('#fileInputLabel').removeClass('has-file').html('<i class="fas fa-cloud-upload-alt"></i> Pilih file foto baru atau seret ke sini');
                }
            });
