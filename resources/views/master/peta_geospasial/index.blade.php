...
<html lang="id">
<head>
    <title>Peta Geospasial - CSSR</title>
...
<body class="bg-gray-50">
    ...
    <div class="ml-64 p-6 fade-in">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-gray-600">Visualisasi data kartu keluarga berdasarkan lokasi geografis</p>
                ...
                <div class="flex items-center">
                    ...
                    <a href="{{ route('kartu_keluarga.index') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-3 rounded-lg transition flex items-center gap-2 shadow-md">
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm mb-8 card-hover">
            ...
            <form action="{{ route('peta_geospasial.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                ...
                <div class="flex items-end space-x-2">
                    ...
                    @if ($kecamatan_id || $kelurahan_id || $marker_color)
                        <a href="{{ route('peta_geospasial.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition flex items-center gap-2 h-10">
    ...
    <script>
        $(document).ready(function() {
            ...
            const showKkBaseUrl = '{{ route("kartu_keluarga.show", ["id" => ":id"]) }}';
                    ...
                    const popupContent = `
                        <div class="popup-content">
                            ...
                            <div class="action-buttons">
                                <a href="{{ url('kartu_keluarga') }}/${kk.id}/edit" class="action-btn">
            ...
            // Event listener untuk kecamatan dropdown
