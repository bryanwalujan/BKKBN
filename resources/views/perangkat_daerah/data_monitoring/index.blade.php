                ...
                <tbody class="divide-y divide-gray-200">
                    @foreach ($dataMonitorings as $dataMonitoring)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <a href="{{ route('perangkat_daerah.data_monitoring.edit', $dataMonitoring->id) }}" class="text-blue-600 hover:text-blue-900">Edit</a>
                                <form action="{{ route('perangkat_daerah.data_monitoring.destroy', $dataMonitoring->id) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
