...
<body class="bg-gray-100">
    ...
    <div class="ml-64 p-6">
        ...
        <a href="{{ route('perangkat_daerah.kartu_keluarga.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded mb-4 inline-block hover:bg-gray-600">Kembali</a>
                            ...
                            <tr class="border-b hover:bg-gray-50">
                                ...
                                <td class="p-4">
                                    <ul class="list-disc">
                                        ...
                                        <li>Konsumsi Tablet Tambah Darah bagi Ibu Hamil: {{ $aksi->tablet_tambah_darah ?? '-' }}</li>
