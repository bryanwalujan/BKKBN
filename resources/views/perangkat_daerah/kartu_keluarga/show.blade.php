...
<head>
    ...
    <title>Detail Kartu Keluarga - Perangkat Daerah</title>
...
<body class="bg-gray-50 font-sans">
            ...
            <div class="px-8 py-4">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-3">
                        <a href="{{ route('perangkat_daerah.kartu_keluarga.index') }}" class="action-btn action-btn-secondary">
        ...
        <div class="p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div class="summary-card card-hover">
                    ...
                    <div class="summary-count">{{ $kartuKeluarga->ibu->count() }}</div>
                    <div class="summary-label">Jumlah Ibu</div>
                </div>
                <div class="summary-card card-hover">
                    <div class="summary-icon bg-green-100 text-green-600">
                        <i class="fas fa-baby text-xl"></i>
                    </div>
                    <div class="summary-count">{{ $kartuKeluarga->balitas->count() }}</div>
                    <div class="summary-label">Jumlah Balita</div>
                </div>
                <div class="summary-card card-hover">
                    <div class="summary-icon bg-purple-100 text-purple-600">
                        <i class="fas fa-user-tie text-xl"></i>
                    </div>
                    <div class="summary-count">{{ $kartuKeluarga->pendampingKeluargas->count() }}</div>
                    <div class="summary-label">Pendamping Keluarga</div>
                </div>
                <div class="summary-card card-hover">
                    <div class="summary-icon bg-yellow-100 text-yellow-600">
                        <i class="fas fa-chart-line text-xl"></i>
                    </div>
                    <div class="summary-count">{{ $kartuKeluarga->dataMonitorings->count() }}</div>
                    <div class="summary-label">Riwayat Monitoring</div>
                </div>
            </div>
                ...
                <div class="section-content">
                    @if ($kartuKeluarga->pendampingKeluargas->isEmpty())
                        <div class="empty-state">
                            ...
                            <p class="text-sm mt-1">Belum ada data pendamping keluarga untuk kartu keluarga ini</p>
                        </div>
                    @else
                        <div class="space-y-6">
                ...
                <div class="section-content">
                    @if ($kartuKeluarga->ibu->isEmpty())
                        <div class="empty-state">
                            ...
                            <p class="text-sm mt-1">Belum ada data ibu untuk kartu keluarga ini</p>
                        </div>
                    @else
                ...
                <div class="section-content">
                    @if ($kartuKeluarga->balitas->isEmpty())
                        <div class="empty-state">
                            ...
                            <p class="text-sm mt-1">Belum ada data balita untuk kartu keluarga ini</p>
                        </div>
                    @else
                        <div class="table-container">
                            <table class="w-full">
                ...
                <div class="section-content">
                    @if ($kartuKeluarga->aksiKonvergensis->isEmpty())
                        <div class="empty-state">
                            ...
                            <p class="text-sm mt-1">Belum ada data aksi konvergensi untuk kartu keluarga ini</p>
                        </div>
                    @else
                        <div class="space-y-6">
                ...
                <div class="section-content">
                    @if ($kartuKeluarga->gentings->isEmpty())
                        <div class="empty-state">
                            ...
                            <p class="text-sm mt-1">Belum ada data kegiatan genting untuk kartu keluarga ini</p>
                        </div>
                    @else
                        <div class="table-container">
                            <table class="w-full">
                ...
                <div class="section-content">
                    @if ($kartuKeluarga->dataMonitorings->isEmpty())
                        <div class="empty-state">
                            ...
                            <p class="text-sm mt-1">Belum ada data monitoring untuk kartu keluarga ini</p>
                        </div>
                    @else
                        <div class="table-container">
                            <table class="w-full">
    ...
    <script>
        $(document).ready(function() {
            // Animasi untuk collapsible sections
