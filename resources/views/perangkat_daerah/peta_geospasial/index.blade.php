...
<body class="bg-gray-50">
    ...
    <div class="ml-64 p-6 fade-in">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-gray-600">Visualisasi data kartu keluarga berdasarkan lokasi geografis di {{ auth()->user()->kecamatan->nama_kecamatan }}</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8">
            <div class="user-info-card p-5 shadow-sm">
                <div class="flex justify-between items-start">
                    <div>
                        <p class="text-sm font-medium text-white/80">Wilayah Kerja</p>
                        <h3 class="text-xl font-bold text-white mt-1">{{ auth()->user()->kecamatan->nama_kecamatan }}</h3>
                    </div>
        ...
        <div class="bg-white rounded-xl shadow-sm overflow-hidden card-hover p-6">
            <div class="flex justify-between items-center mb-4">
                <div>
                    <h3 class="text-xl font-semibold text-gray-800">Peta Geospasial - {{ auth()->user()->kecamatan->nama_kecamatan }}</h3>
