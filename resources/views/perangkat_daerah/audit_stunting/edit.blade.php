...
<head>
    ...
    <title>Edit Data Audit Stunting - Perangkat Daerah</title>
...
<body class="bg-gray-50 font-sans">
    ...
    <div class="ml-64 min-h-screen">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="flex items-center mt-1 space-x-4">
                            <p class="text-gray-600">Perbarui data audit stunting untuk wilayah Anda</p>
                            @if($kecamatan)
        ...
        <div class="p-8">
            ...
            <form method="POST" action="{{ route('perangkat_daerah.audit_stunting.update', $auditStunting->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                                ...
                                <div class="relative">
                                    <select name="kelurahan_id" id="kelurahan_id" 
                                        ...
                                        @foreach ($kelurahans as $kelurahan)
                                            <option value="{{ $kelurahan->id }}" {{ old('kelurahan_id', $dataMonitoring->kelurahan_id) == $kelurahan->id ? 'selected' : '' }}>
                    ...
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="pihak_pengaudit" id="pihak_pengaudit" value="{{ old('pihak_pengaudit', $auditStunting->pihak_pengaudit) }}" 
                                ...
                                @if ($auditStunting->foto_dokumentasi)
                                    <div class="file-preview mt-2">
                                        <div class="flex items-center">
                                            ...
                                            <a href="{{ Storage::url($auditStunting->foto_dokumentasi) }}" target="_blank" 
                                               class="ml-2 text-blue-600 hover:text-blue-800 text-sm font-medium flex items-center">
