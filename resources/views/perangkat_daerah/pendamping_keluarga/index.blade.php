...
<head>
    ...
    <title>Perangkat Daerah - Pendamping Keluarga</title>
    ...
    <div class="ml-64 min-h-screen">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-800 flex items-center">
                            ...
                            Pendamping Keluarga - Perangkat Daerah
                        </h1>
                        <p class="text-gray-600 mt-1">Manajemen data pendamping dan supervisor keluarga untuk perangkat daerah</p>
                    </div>
        ...
        <div class="p-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
                ...
                <a href="{{ route('perangkat_daerah.pendamping_keluarga.create') }}" class="bg-gradient-to-r from-green-500 to-green-600 rounded-xl shadow-sm p-6 card-hover group cursor-pointer">
            ...
            <div class="bg-white rounded-xl shadow-sm border p-6 mb-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    @if (request('search'))
                        <a href="{{ route('perangkat_daerah.pendamping_keluarga.index') }}" class="text-sm text-gray-600 hover:text-gray-800 flex items-center">
                ...
                <form action="{{ route('perangkat_daerah.pendamping_keluarga.index') }}" method="GET" class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    <div>
                    ...
                    <div class="lg:col-span-2 flex justify-end">
                        <button type="submit" class="bg-green-500 hover:bg-green-600 text-white font-medium py-3 px-6 rounded-lg transition-colors flex items-center justify-center">
                    ...
                    <div class="mt-4 p-4 bg-green-50 rounded-lg border border-green-200">
                        ...
                        <div class="mt-2 flex flex-wrap gap-2">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                                ...
                                <a href="{{ route('perangkat_daerah.pendamping_keluarga.index') }}" class="ml-1 hover:text-purple-600">
                                    <i class="fas fa-times"></i>
                                </a>
                            </span>
                        </div>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center space-x-2">
                                            @if ($pendamping->kartuKeluargas->isNotEmpty())
                                                <a href="{{ route('perangkat_daerah.kartu_keluarga.show', $pendamping->kartuKeluargas->first()->id) }}" 
                                            ...
                                            @endif
                                            <a href="{{ route('perangkat_daerah.pendamping_keluarga.edit', $pendamping->id) }}" 
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.delete-btn').on('click', function() {
                ...
                const url = '{{ route("perangkat_daerah.pendamping_keluarga.destroy", ":id") }}'.replace(':id', id);
