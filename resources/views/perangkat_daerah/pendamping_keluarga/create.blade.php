...
<head>
    ...
    <title>Tambah Pendamping Keluarga - Perangkat Daerah</title>
...
<body class="bg-gray-50 font-sans">
    ...
    <div class="ml-64 min-h-screen">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-800 flex items-center">
                            ...
                            Tambah Pendamping Keluarga
                        </h1>
                        <p class="text-gray-600 mt-1">Tambah data pendamping keluarga baru untuk wilayah Anda</p>
                    </div>
        ...
        <div class="p-8">
            ...
            <form action="{{ route('perangkat_daerah.pendamping_keluarga.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Masukkan data pribadi pendamping keluarga</p>
                    </div>
                        ...
                        <div>
                            ...
                            <select name="kartu_keluarga_ids[]" id="kartu_keluarga_ids" multiple 
                                ...
                                @foreach ($kartuKeluargas as $kk)
                                    <option value="{{ $kk->id }}" {{ in_array($kk->id, old('kartu_keluarga_ids', [])) ? 'selected' : '' }}>
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Masukkan informasi status dan tambahan pendamping</p>
                    </div>
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="tahun_bergabung" id="tahun_bergabung" value="{{ old('tahun_bergabung') }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-green-500 focus:ring-green-500 p-3 pl-10"
                        ...
                        <div class="space-y-4">
                            <div class="activity-checkbox">
                                ...
                                <div class="w-1/2 ml-4">
                                    <input type="text" name="penyuluhan_frekuensi" id="penyuluhan_frekuensi" value="{{ old('penyuluhan_frekuensi') }}" 
                            ...
                            <div class="activity-checkbox">
                                ...
                                <div class="w-1/2 ml-4">
                                    <input type="text" name="rujukan_frekuensi" id="rujukan_frekuensi" value="{{ old('rujukan_frekuensi') }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-green-500 focus:ring-green-500 p-2"
                            ...
                            <div class="activity-checkbox">
                                ...
                                <div class="w-1/2 ml-4">
                                    <input type="text" name="kunjungan_krs_frekuensi" id="kunjungan_krs_frekuensi" value="{{ old('kunjungan_krs_frekuensi') }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-green-500 focus:ring-green-500 p-2"
                            ...
                            <div class="activity-checkbox">
                                ...
                                <div class="w-1/2 ml-4">
                                    <input type="text" name="pendataan_bansos_frekuensi" id="pendataan_bansos_frekuensi" value="{{ old('pendataan_bansos_frekuensi') }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-green-500 focus:ring-green-500 p-2"
                                           placeholder="Frekuensi (misal: 1 kali/bulan)">
    ...
    <script>
        $(document).ready(function() {
            ...
            const initialKelurahanId = '{{ old("kelurahan_id") }}';
