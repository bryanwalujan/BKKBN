    ...
    <div class="ml-64 p-6">
        ...
        <form action="{{ route('perangkat_daerah.genting.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="narasi" id="narasi" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" rows="4">{{ old('narasi') }}</textarea>
                @error('narasi')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="dunia_usaha" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    ...
                    <input type="text" name="dunia_usaha_frekuensi" value="{{ old('dunia_usaha_frekuensi') }}" placeholder="Frekuensi" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Pemerintah</label>
                    <select name="pemerintah" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                        <option value="">Tidak</option>
                        <option value="ada" {{ old('pemerintah') == 'ada' ? 'selected' : '' }}>Ada</option>
                        <option value="tidak" {{ old('pemerintah') == 'tidak' ? 'selected' : '' }}>Tidak</option>
                    </select>
                    <input type="text" name="pemerintah_frekuensi" value="{{ old('pemerintah_frekuensi') }}" placeholder="Frekuensi" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">BUMN dan BUMD</label>
                    <select name="bumn_bumd" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                        <option value="">Tidak</option>
                        <option value="ada" {{ old('bumn_bumd') == 'ada' ? 'selected' : '' }}>Ada</option>
                        <option value="tidak" {{ old('bumn_bumd') == 'tidak' ? 'selected' : '' }}>Tidak</option>
                    </select>
                    <input type="text" name="bumn_bumd_frekuensi" value="{{ old('bumn_bumd_frekuensi') }}" placeholder="Frekuensi" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Individu dan Perseorangan</label>
                    <select name="individu_perseorangan" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                        <option value="">Tidak</option>
                    ...
                    <input type="text" name="individu_perseorangan_frekuensi" value="{{ old('individu_perseorangan_frekuensi') }}" placeholder="Frekuensi" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">LSM dan Komunitas</label>
                    <select name="lsm_komunitas" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                        <option value="">Tidak</option>
                    ...
                    <input type="text" name="lsm_komunitas_frekuensi" value="{{ old('lsm_komunitas_frekuensi') }}" placeholder="Frekuensi" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Swasta</label>
                    <select name="swasta" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                        <option value="">Tidak</option>
                        <option value="ada" {{ old('swasta') == 'ada' ? 'selected' : '' }}>Ada</option>
                        <option value="tidak" {{ old('swasta') == 'tidak' ? 'selected' : '' }}>Tidak</option>
                    </select>
                    <input type="text" name="swasta_frekuensi" value="{{ old('swasta_frekuensi') }}" placeholder="Frekuensi" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Perguruan Tinggi dan Akademisi</label>
                    <select name="perguruan_tinggi_akademisi" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                        <option value="">Tidak</option>
                    ...
                    <input type="text" name="perguruan_tinggi_akademisi_frekuensi" value="{{ old('perguruan_tinggi_akademisi_frekuensi') }}" placeholder="Frekuensi" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Media</label>
                    <select name="media" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                        <option value="">Tidak</option>
                        <option value="ada" {{ old('media') == 'ada' ? 'selected' : '' }}>Ada</option>
                        <option value="tidak" {{ old('media') == 'tidak' ? 'selected' : '' }}>Tidak</option>
                    </select>
                    <input type="text" name="media_frekuensi" value="{{ old('media_frekuensi') }}" placeholder="Frekuensi" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Tim Pendamping Keluarga</label>
                    <select name="tim_pendamping_keluarga" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                        <option value="">Tidak</option>
                    ...
                    <input type="text" name="tim_pendamping_keluarga_frekuensi" value="{{ old('tim_pendamping_keluarga_frekuensi') }}" placeholder="Frekuensi" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Tokoh Masyarakat</label>
                    <select name="tokoh_masyarakat" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                        <option value="">Tidak</option>
                    ...
                    <input type="text" name="tokoh_masyarakat_frekuensi" value="{{ old('tokoh_masyarakat_frekuensi') }}" placeholder="Frekuensi" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                </div>
            </div>
