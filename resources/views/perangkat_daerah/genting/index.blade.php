    ...
    <div class="ml-64 min-h-screen">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-800 flex items-center">
                            ...
                            Data Kegiatan Genting - Kecamatan {{ auth()->user()->kecamatan->nama_kecamatan }}
                        </h1>
                        <p class="text-gray-600 mt-1">Manajemen kegiatan genting di wilayah Anda</p>
                    </div>
        ...
        <div class="p-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
                ...
                <a href="{{ route('perangkat_daerah.genting.create') }}" class="bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-xl shadow-sm p-6 card-hover group cursor-pointer">
            ...
            <div class="bg-white rounded-xl shadow-sm border p-6 mb-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    @if ($search)
                        <a href="{{ route('perangkat_daerah.genting.index') }}" class="text-sm text-gray-600 hover:text-gray-800 flex items-center">
                ...
                <form action="{{ route('perangkat_daerah.genting.index') }}" method="GET" class="flex gap-4">
                    <div class="flex-1">
                        <div class="relative">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center space-x-2">
                                            <a href="{{ route('perangkat_daerah.genting.edit', $genting->id) }}" 
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.delete-btn').on('click', function() {
                ...
                const url = '{{ route("perangkat_daerah.genting.destroy", ":id") }}'.replace(':id', id);
