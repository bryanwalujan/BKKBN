...
<head>
    ...
    <title>Edit Aksi Konvergensi - Perangkat Daerah</title>
...
<body class="bg-gray-50 font-sans">
    ...
    <div class="ml-64 min-h-screen">
            ...
            <div class="px-8 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Edit data aksi konvergensi untuk penanganan stunting</p>
                        <div class="mt-2 flex items-center">
                            <span class="text-sm text-gray-500 mr-2">Status saat ini:</span>
                            @if($aksiKonvergensi->selesai)
        ...
        <div class="p-8">
            ...
            <form action="{{ route('perangkat_daerah.aksi_konvergensi.update', $aksiKonvergensi->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#remove-photo-btn').on('click', function() {
                Swal.fire({
                    title: 'Hapus Foto?',
                    text: "Foto saat ini akan dihapus dari aksi konvergensi ini",
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        ...
                        Swal.fire(
                            'Dihapus!',
                            'Foto telah ditandai untuk dihapus.',
                            'success'
                        );
                    }
                });
