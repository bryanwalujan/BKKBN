...
<body class="bg-gray-100">
    <nav class="bg-blue-600 p-4">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            <h1 class="text-white text-xl font-bold">Dashboard Admin Kelurahan</h1>
    ...
    <div class="max-w-7xl mx-auto py-6 px-4">
        <h2 class="text-2xl font-semibold mb-4">Selamat Datang, Admin Kelurahan!</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="bg-white p-6 rounded shadow">
                <h3 class="text-lg font-medium">Input Data Keluarga</h3>
                <p class="text-gray-600">Tambahkan data keluarga di kelurahan Anda.</p>
