...
<body class="bg-gray-100">
    ...
    <div class="ml-64 p-6">
        ...
        @else
            <form action="{{ route('kelurahan.ibu.update', $ibu->id) }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded shadow">
                @csrf
                @method('PUT')
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <select name="kartu_keluarga_id" id="kartu_keluarga_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                        ...
                        @foreach ($kartuKeluargas as $kk)
                            <option value="{{ $kk->id }}" {{ old('kartu_keluarga_id', $ibu->kartu_keluarga_id) == $kk->id ? 'selected' : '' }}>{{ $kk->nomor_kk }} - {{ $kk->kepala_keluarga }}</option>
                        @endforeach
                    </select>
                ...
                <div class="mb-4">
                    ...
                    @if ($ibu->foto)
                        <img src="{{ Storage::url($ibu->foto) }}" alt="Foto Ibu" class="mb-2 w-32 h-32 object-cover">
                    @endif
                ...
                <div id="hamil_fields" class="hidden">
                    <div class="mb-4">
                        ...
                        <select name="trimester" id="trimester" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                            <option value="" {{ old('trimester', $ibu->ibuHamil->trimester ?? '') == '' ? 'selected' : '' }}>-- Pilih Trimester --</option>
                            <option value="Trimester 1" {{ old('trimester', $ibu->ibuHamil->trimester ?? '') == 'Trimester 1' ? 'selected' : '' }}>Trimester 1</option>
                            <option value="Trimester 2" {{ old('trimester', $ibu->ibuHamil->trimester ?? '') == 'Trimester 2' ? 'selected' : '' }}>Trimester 2</option>
                            <option value="Trimester 3" {{ old('trimester', $ibu->ibuHamil->trimester ?? '') == 'Trimester 3' ? 'selected' : '' }}>Trimester 3</option>
                        </select>
                        @error('trimester')
                            <span class="text-red-600 text-sm">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="mb-4">
                        ...
                        <select name="intervensi" id="intervensi" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                            <option value="" {{ old('intervensi', $ibu->ibuHamil->intervensi ?? '') == '' ? 'selected' : '' }}>-- Pilih Intervensi --</option>
                            <option value="Tidak Ada" {{ old('intervensi', $ibu->ibuHamil->intervensi ?? '') == 'Tidak Ada' ? 'selected' : '' }}>Tidak Ada</option>
                            <option value="Gizi" {{ old('intervensi', $ibu->ibuHamil->intervensi ?? '') == 'Gizi' ? 'selected' : '' }}>Gizi</option>
                            <option value="Konsultasi Medis" {{ old('intervensi', $ibu->ibuHamil->intervensi ?? '') == 'Konsultasi Medis' ? 'selected' : '' }}>Konsultasi Medis</option>
                            <option value="Lainnya" {{ old('intervensi', $ibu->ibuHamil->intervensi ?? '') == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                        </select>
                        @error('intervensi')
                            <span class="text-red-600 text-sm">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="mb-4">
                        ...
                        <select name="status_gizi" id="status_gizi" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                            <option value="" {{ old('status_gizi', $ibu->ibuHamil->status_gizi ?? '') == '' ? 'selected' : '' }}>-- Pilih Status Gizi --</option>
                            <option value="Normal" {{ old('status_gizi', $ibu->ibuHamil->status_gizi ?? '') == 'Normal' ? 'selected' : '' }}>Normal</option>
                            <option value="Kurang Gizi" {{ old('status_gizi', $ibu->ibuHamil->status_gizi ?? '') == 'Kurang Gizi' ? 'selected' : '' }}>Kurang Gizi</option>
                            <option value="Berisiko" {{ old('status_gizi', $ibu->ibuHamil->status_gizi ?? '') == 'Berisiko' ? 'selected' : '' }}>Berisiko</option>
                        </select>
                        @error('status_gizi')
                            <span class="text-red-600 text-sm">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="mb-4">
                        ...
                        <select name="warna_status_gizi" id="warna_status_gizi" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                            <option value="" {{ old('warna_status_gizi', $ibu->ibuHamil->warna_status_gizi ?? '') == '' ? 'selected' : '' }}>-- Pilih Warna --</option>
                            <option value="Sehat" {{ old('warna_status_gizi', $ibu->ibuHamil->warna_status_gizi ?? '') == 'Sehat' ? 'selected' : '' }}>Sehat</option>
                            <option value="Waspada" {{ old('warna_status_gizi', $ibu->ibuHamil->warna_status_gizi ?? '') == 'Waspada' ? 'selected' : '' }}>Waspada</option>
                            <option value="Bahaya" {{ old('warna_status_gizi', $ibu->ibuHamil->warna_status_gizi ?? '') == 'Bahaya' ? 'selected' : '' }}>Bahaya</option>
                        </select>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="usia_kehamilan" id="usia_kehamilan" value="{{ old('usia_kehamilan', $ibu->ibuHamil->usia_kehamilan ?? '') }}" min="0" max="40" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="berat_hamil" id="berat_hamil" value="{{ old('berat_hamil', $ibu->ibuHamil->berat ?? '') }}" step="0.1" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                        @error('berat_hamil')
                            <span class="text-red-600 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="mb-4">
                        ...
                        <input type="number" name="tinggi_hamil" id="tinggi_hamil" value="{{ old('tinggi_hamil', $ibu->ibuHamil->tinggi ?? '') }}" step="0.1" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                        @error('tinggi_hamil')
                            <span class="text-red-600 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div id="nifas_fields" class="hidden">
                    <div class="mb-4">
                        ...
                        <input type="number" name="hari_nifas" id="hari_nifas" value="{{ old('hari_nifas', $ibu->ibuNifas->hari_nifas ?? '') }}" min="0" max="42" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                        @error('hari_nifas')
                            <span class="text-red-600 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="mb-4">
                        ...
                        <select name="kondisi_kesehatan" id="kondisi_kesehatan" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                            <option value="" {{ old('kondisi_kesehatan', $ibu->ibuNifas->kondisi_kesehatan ?? '') == '' ? 'selected' : '' }}>-- Pilih Kondisi --</option>
                            <option value="Normal" {{ old('kondisi_kesehatan', $ibu->ibuNifas->kondisi_kesehatan ?? '') == 'Normal' ? 'selected' : '' }}>Normal</option>
                            <div class="mb-4">
                        <label for="berat_nifas" class="block text-sm font-medium text-gray-700">Berat (kg)</label>
                        <input type="number" name="berat_nifas" id="berat_nifas" value="{{ old('berat_nifas', $ibu->ibuNifas->berat ?? '') }}" step="0.1" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                        @error('berat_nifas')
                            <span class="text-red-600 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="mb-4">
                        ...
                        <input type="number" name="tinggi_nifas" id="tinggi_nifas" value="{{ old('tinggi_nifas', $ibu->ibuNifas->tinggi ?? '') }}" step="0.1" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                        @error('tinggi_nifas')
                            <span class="text-red-600 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div id="menyusui_fields" class="hidden">
                    <div class="mb-4">
                        ...
                        <select name="status_menyusui" id="status_menyusui" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                            <option value="" {{ old('status_menyusui', $ibu->ibuMenyusui->status_menyusui ?? '') == '' ? 'selected' : '' }}>-- Pilih Status --</option>
                            <option value="Eksklusif" {{ old('status_menyusui', $ibu->ibuMenyusui->status_menyusui ?? '') == 'Eksklusif' ? 'selected' : '' }}>Eksklusif</option>
                            <option value="Non-Eksklusif" {{ old('status_menyusui', $ibu->ibuMenyusui->status_menyusui ?? '') == 'Non-Eksklusif' ? 'selected' : '' }}>Non-Eksklusif</option>
                        </select>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="frekuensi_menyusui" id="frekuensi_menyusui" value="{{ old('frekuensi_menyusui', $ibu->ibuMenyusui->frekuensi_menyusui ?? '') }}" min="0" max="24" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="kondisi_ibu" id="kondisi_ibu" value="{{ old('kondisi_ibu', $ibu->ibuMenyusui->kondisi_ibu ?? '') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                        @error('kondisi_ibu')
                            <span class="text-red-600 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="mb-4">
                        ...
                        <select name="warna_kondisi_menyusui" id="warna_kondisi_menyusui" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                            <option value="" {{ old('warna_kondisi_menyusui', $ibu->ibuMenyusui->warna_kondisi ?? '') == '' ? 'selected' : '' }}>-- Pilih Warna --</option>
                            <option value="Hijau (success)" {{ old('warna_kondisi_menyusui', $ibu->ibuMenyusui->warna_kondisi ?? '') == 'Hijau (success)' ? 'selected' : '' }}>Hijau (success)</option>
                            <option value="Kuning (warning)" {{ old('warna_kondisi_menyusui', $ibu->ibuMenyusui->warna_kondisi ?? '') == 'Kuning (warning)' ? 'selected' : '' }}>Kuning (warning)</option>
                            <option value="Merah (danger)" {{ old('warna_kondisi_menyusui', $ibu->ibuMenyusui->warna_kondisi ?? '') == 'Merah (danger)' ? 'selected' : '' }}>Merah (danger)</option>
                        </select>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="berat_menyusui" id="berat_menyusui" value="{{ old('berat_menyusui', $ibu->ibuMenyusui->berat ?? '') }}" step="0.1" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="tinggi_menyusui" id="tinggi_menyusui" value="{{ old('tinggi_menyusui', $ibu->ibuMenyusui->tinggi ?? '') }}" step="0.1" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
