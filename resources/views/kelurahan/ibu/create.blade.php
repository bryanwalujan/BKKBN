...
<head>
    ...
    <title>Tambah Data Ibu - Panel Kelurahan</title>
...
<body class="bg-gray-50 font-sans">
    ...
    <div class="ml-64 min-h-screen">
        ...
        <div class="p-8">
            ...
            @else
                <form id="createIbuForm" action="{{ route('kelurahan.ibu.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#createIbuForm').on('submit', function(e) {
                e.preventDefault();
                const form = $(this);
                Swal.fire({
                    title: 'Simpan Data?',
                    text: 'Apakah Anda yakin ingin menyimpan data ibu ini?',
                    icon: 'question',
                        ...
                        $.ajax({
                            ...
                            success: function() {
                                Swal.fire({
                                    icon: 'success',
                                    title: 'Berhasil',
                                    text: 'Data ibu berhasil ditambahkan.',
                                    confirmButtonColor: '#3b82f6',
                                }).then(() => {
