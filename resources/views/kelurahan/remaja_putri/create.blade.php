...
<head>
    ...
    <title>Tambah Remaja Putri - CSSR Kelurahan</title>
    ...
    <div class="ml-64 p-6 fade-in">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800 mb-2">Tambah <span class="gradient-text">Data Remaja Putri</span></h1>
                    <p class="text-gray-600">Tambah data remaja putri baru ke dalam sistem CSSR</p>
                ...
                <div class="flex items-center">
                    <a href="{{ route('kelurahan.remaja_putri.index', ['tab' => 'pending']) }}" class="text-pink-500 hover:text-pink-700 mr-4 flex items-center">
        ...
        @else
            <form action="{{ route('kelurahan.remaja_putri.store') }}" method="POST" enctype="multipart/form-data" id="remajaPutriForm">
                @csrf
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm mb-8 card-hover">
                    <div class="flex justify-between items-center mb-6">
                        <div>
                            ...
                            <p class="text-gray-600 text-sm mt-1">Isi informasi lengkap data remaja putri</p>
                        </div>
                        <div class="flex items-center text-sm text-pink-500">
                            <i class="fas fa-female mr-2"></i>
                            <span>Form Tambah Remaja Putri - Kelurahan</span>
                        </div>
                    </div>
                    ...
                    <div class="info-box">
                        <p>
                            ...
                            Pastikan data yang dimasukkan akurat dan lengkap untuk pemantauan kesehatan remaja putri yang optimal.
                        </p>
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama" id="nama" value="{{ old('nama') }}" class="form-input" placeholder="Masukkan nama lengkap remaja putri" required>
                                @error('nama')
                                    <div class="error-message">
                                        <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="sekolah" id="sekolah" value="{{ old('sekolah') }}" class="form-input" placeholder="Masukkan nama sekolah" required>
                                @error('sekolah')
                                    <div class="error-message">
                                        <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="kelas" id="kelas" value="{{ old('kelas') }}" class="form-input" placeholder="Masukkan kelas" required>
                                @error('kelas')
                                    <div class="error-message">
                                        <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="umur" id="umur" value="{{ old('umur') }}" min="10" max="19" class="form-input" placeholder="10-19" required>
                                @error('umur')
                                    <div class="error-message">
                                        <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                    </div>
                    ...
                    <div class="flex justify-between pt-6 border-t border-gray-200">
                        <a href="{{ route('kelurahan.remaja_putri.index', ['tab' => 'pending']) }}" class="btn btn-secondary">
                            <i class="fas fa-times"></i> Batal
                        </a>
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save"></i> Simpan Data Remaja Putri
                        </button>
                    </div>
                </div>
            </form>
