...
<head>
    ...
    <title>Edit Data Ibu Menyusui - Panel Kelurahan</title>
...
<body class="bg-gray-50 font-sans">
    ...
    <div class="ml-64 min-h-screen">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-800 flex items-center">
                            ...
                            Edit Data Ibu Menyusui
                        </h1>
                        <p class="text-gray-600 mt-1">Perbarui data ibu menyusui dalam sistem kelurahan</p>
                    </div>
        ...
        <div class="p-8">
            ...
            <form action="{{ route('kelurahan.ibu_menyusui.update', $ibuMenyusui->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Pilih data ibu yang akan diperbarui dalam sistem ibu menyusui</p>
                    </div>
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Perbarui status dan frekuensi menyusui</p>
                    </div>
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="frekuensi_menyusui" id="frekuensi_menyusui" 
                                           value="{{ old('frekuensi_menyusui', $ibuMenyusui->frekuensi_menyusui) }}" 
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Perbarui informasi kondisi kesehatan ibu</p>
                    </div>
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="kondisi_ibu" id="kondisi_ibu" 
                                           value="{{ old('kondisi_ibu', $ibuMenyusui->kondisi_ibu) }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-green-500 focus:ring-green-500 p-3 pl-10"
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Perbarui data pengukuran fisik ibu</p>
                    </div>
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="berat" id="berat" 
                                           value="{{ old('berat', $ibuMenyusui->berat) }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-green-500 focus:ring-green-500 p-3 pl-10"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="tinggi" id="tinggi" 
                                           value="{{ old('tinggi', $ibuMenyusui->tinggi) }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-green-500 focus:ring-green-500 p-3 pl-10"
                                           step="0.1" placeholder="0.0" required>
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
