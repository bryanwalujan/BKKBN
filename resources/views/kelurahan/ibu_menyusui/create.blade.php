...
<head>
    ...
    <title>Tambah Data Ibu Menyusui - CSSR Kelurahan</title>
...
<body class="bg-gray-50">
    ...
    <div class="ml-64 p-6 fade-in">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-gray-600">Tambah data ibu menyusui baru ke dalam sistem CSSR</p>
        ...
        <form action="{{ route('kelurahan.ibu_menyusui.store') }}" method="POST" id="ibuMenyusuiForm">
            @csrf
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm mb-8 card-hover">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p class="text-gray-600 text-sm mt-1">Isi informasi lengkap data ibu menyusui</p>
                    </div>
                    <div class="flex items-center text-sm text-blue-500">
                        <i class="fas fa-baby mr-2"></i>
                        <span>Form Tambah Ibu Menyusui - Kelurahan</span>
                    </div>
                </div>
                ...
                <div class="info-box">
                    <p>
                        ...
                        Pastikan data yang dimasukkan akurat dan lengkap untuk pemantauan kesehatan ibu dan bayi yang optimal.
                    </p>
                </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" name="frekuensi_menyusui" id="frekuensi_menyusui" value="{{ old('frekuensi_menyusui') }}" min="0" max="24" class="form-input" required>
                            </div>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="text" name="kondisi_ibu" id="kondisi_ibu" value="{{ old('kondisi_ibu') }}" class="form-input" placeholder="Masukkan kondisi kesehatan ibu" required>
                            </div>
                            @error('kondisi_ibu')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" name="berat" id="berat" value="{{ old('berat') }}" step="0.1" class="form-input" placeholder="Contoh: 55.5" required>
                            </div>
                            @error('berat')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" name="tinggi" id="tinggi" value="{{ old('tinggi') }}" step="0.1" class="form-input" placeholder="Contoh: 160.5" required>
                            </div>
                            @error('tinggi')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                ...
                <div class="flex justify-between pt-6 border-t border-gray-200">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Simpan Data Ibu Menyusui
                    </button>
                </div>
            </div>
        </form>
