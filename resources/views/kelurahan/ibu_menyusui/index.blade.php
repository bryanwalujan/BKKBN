...
<head>
    ...
    <title>Data Ibu Menyusui - Admin Kelurahan</title>
    ...
    <div class="ml-64 min-h-screen">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-800 flex items-center">
                            ...
                            Data Ibu Menyusui - Kelurahan
                        </h1>
                        <p class="text-gray-600 mt-1">Manajemen data ibu menyusui di wilayah kelurahan Anda</p>
                    </div>
        ...
        <div class="p-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
                ...
                <a href="{{ route('kelurahan.ibu_menyusui.create') }}" class="bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-xl shadow-sm p-6 card-hover group cursor-pointer">
            ...
            <div class="bg-white rounded-xl shadow-sm border p-6 mb-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    @if ($search)
                        <a href="{{ route('kelurahan.ibu_menyusui.index') }}" class="text-sm text-gray-600 hover:text-gray-800 flex items-center">
                ...
                <form action="{{ route('kelurahan.ibu_menyusui.index') }}" method="GET" class="flex flex-col lg:flex-row gap-4">
                    <div class="flex-grow">
                                ...
                                <tr class="table-row-hover transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center space-x-2">
                                            <a href="{{ route('kelurahan.ibu_menyusui.edit', $ibu->id) }}" 
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.delete-btn').on('click', function(e) {
                ...
                const url = '{{ route("kelurahan.ibu_menyusui.destroy", ":id") }}'.replace(':id', id);
