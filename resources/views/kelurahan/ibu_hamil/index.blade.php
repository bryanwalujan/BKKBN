...
<body class="bg-gray-100">
    ...
    <div class="ml-64 p-6">
        ...
        <div class="mb-4 flex space-x-4">
            <form action="{{ route('kelurahan.ibu_hamil.index') }}" method="GET" class="flex items-center space-x-2">
                ...
                @if ($search)
                    <a href="{{ route('kelurahan.ibu_hamil.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600">Reset</a>
                @endif
            </form>
            <a href="{{ route('kelurahan.ibu_hamil.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Tambah Data Ibu Hamil</a>
        </div>
        @if ($search)
                    ...
                    @forelse ($ibuHamils as $index => $ibuHamil)
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="p-4 flex space-x-2">
                                <a href="{{ route('kelurahan.ibu_hamil.edit', $ibuHamil->id) }}" class="text-blue-500 hover:underline">Edit</a>
                                <button type="button" class="text-red-500 hover:underline" onclick="showDeleteModal('{{ route('kelurahan.ibu_hamil.destroy', $ibuHamil->id) }}', '{{ $ibuHamil->ibu->nama }}')">Hapus</button>
                            </td>
                        </tr>
                    @empty
                        <tr>
