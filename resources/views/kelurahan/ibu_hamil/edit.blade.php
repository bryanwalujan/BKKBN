...
<head>
    ...
    <title>Edit Data Ibu Hamil - CSSR Kelurahan</title>
...
<body class="bg-gray-50">
    ...
    <div class="ml-64 p-6 fade-in">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-gray-600">Perbarui data kehamilan untuk pemantauan kesehatan ibu</p>
        ...
        <form action="{{ route('kelurahan.ibu_hamil.update', ['id' => $ibuHamil->id, 'source' => $source]) }}" method="POST" id="ibuHamilForm">
            @csrf
            @method('PUT')
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm mb-8 card-hover">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p class="text-gray-600 text-sm mt-1">Perbarui informasi lengkap data kehamilan ibu</p>
                    </div>
                    <div class="flex items-center text-sm text-blue-500">
                        <i class="fas fa-baby mr-2"></i>
                        <span>Form Edit Data Ibu Hamil - Kelurahan</span>
                    </div>
                </div>
                ...
                <div class="info-box">
                    <p>
                        ...
                        Pastikan data yang diperbarui akurat untuk pemantauan kesehatan ibu hamil yang optimal.
                    </p>
                </div>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <select name="ibu_id" id="ibu_id" class="form-input" required>
                                ...
                                @foreach ($ibus as $ibu)
                                    <option value="{{ $ibu->id }}" data-source="{{ $ibu->source }}" {{ old('ibu_id', $ibuHamil->pending_ibu_id ?? $ibuHamil->ibu_id) == $ibu->id ? 'selected' : '' }}>
                                        {{ $ibu->nama }} ({{ $ibu->nik ?? '-' }}) 
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <div class="trimester-selector">
                                <div class="trimester-card trimester-1 {{ old('trimester', $ibuHamil->trimester) == 'Trimester 1' ? 'selected' : '' }}" data-value="Trimester 1">
                                    <div class="flex items-center">
                                ...
                                <div class="trimester-card trimester-2 {{ old('trimester', $ibuHamil->trimester) == 'Trimester 2' ? 'selected' : '' }}" data-value="Trimester 2">
                                    <div class="flex items-center">
                                ...
                                <div class="trimester-card trimester-3 {{ old('trimester', $ibuHamil->trimester) == 'Trimester 3' ? 'selected' : '' }}" data-value="Trimester 3">
                                    <div class="flex items-center">
                            ...
                            <input type="hidden" name="trimester" id="trimester" value="{{ old('trimester', $ibuHamil->trimester) }}" required>
                            @error('trimester')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" name="usia_kehamilan" id="usia_kehamilan" value="{{ old('usia_kehamilan', $ibuHamil->usia_kehamilan) }}" min="1" max="40" class="form-input" placeholder="Masukkan usia kehamilan" required>
                            </div>
                            <div class="progress-bar">
                                <div class="progress-fill" id="kehamilanProgress" style="width: {{ (old('usia_kehamilan', $ibuHamil->usia_kehamilan) / 40) * 100 }}%"></div>
                            </div>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" name="berat" id="berat" value="{{ old('berat', $ibuHamil->berat) }}" step="0.1" class="form-input" placeholder="Masukkan berat badan" required>
                            </div>
                            @error('berat')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" name="tinggi" id="tinggi" value="{{ old('tinggi', $ibuHamil->tinggi) }}" step="0.1" class="form-input" placeholder="Masukkan tinggi badan" required>
                            </div>
                            @error('tinggi')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                ...
                <div class="flex justify-between pt-6 border-t border-gray-200">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Perbarui Data Ibu Hamil
                    </button>
                </div>
            </div>
        </form>
