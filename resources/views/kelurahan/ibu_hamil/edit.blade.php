...
<head>
    ...
    <title>Edit Data Ibu Hamil - Panel Kelurahan</title>
...
<body class="bg-gray-50 font-sans">
    ...
    <div class="ml-64 min-h-screen">
            ...
            <div class="px-8 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Perbarui data kehamilan ibu dalam sistem kelurahan</p>
                    </div>
        ...
        <div class="p-8">
            ...
            @else
                <form id="editIbuHamilForm" action="{{ route('kelurahan.ibu_hamil.update', $ibuHamil->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-section card-hover">
                        <div class="form-section-header">
                            ...
                            <p class="text-sm text-gray-600 mt-1">Pilih data ibu yang akan diperbarui kehamilannya</p>
                        </div>
                        ...
                        <div class="form-section-body">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="input-with-icon">
                                        <input type="number" name="usia_kehamilan" id="usia_kehamilan" value="{{ old('usia_kehamilan', $ibuHamil->usia_kehamilan) }}" min="0" max="40" step="1" 
                        ...
                        <div class="form-section-body">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div class="input-with-icon">
                                        <input type="number" name="berat" id="berat" value="{{ old('berat', $ibuHamil->berat) }}" step="0.1" min="0" 
                                               class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3" required>
                                        <div class="icon">
                                ...
                                <div>
                                    ...
                                    <div class="input-with-icon">
                                        <input type="number" name="tinggi" id="tinggi" value="{{ old('tinggi', $ibuHamil->tinggi) }}" step="0.1" min="0" 
                                               class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3" required>
                                        <div class="icon">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#editIbuHamilForm').on('submit', function(e) {
                ...
                Swal.fire({
                    title: 'Perbarui Data?',
                    text: 'Apakah Anda yakin ingin memperbarui data ibu hamil ini?',
                    icon: 'question',
