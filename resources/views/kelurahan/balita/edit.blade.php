...
<head>
    ...
    <title>Edit Balita - CSSR Kelurahan</title>
    ...
    <div class="ml-64 p-6 fade-in">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800 mb-2">Edit <span class="gradient-text">Data Balita</span></h1>
                    <p class="text-gray-600">Perbarui data balita dalam sistem CSSR</p>
        ...
        <form action="{{ route('kelurahan.balita.update', ['id' => $balita->id, 'source' => $source]) }}" method="POST" enctype="multipart/form-data" id="balitaForm">
            @csrf
            @method('PUT')
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm mb-8 card-hover">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <h3 class="text-xl font-semibold text-gray-800">Edit Data Balita</h3>
                        <p class="text-gray-600 text-sm mt-1">Perbarui informasi lengkap data balita</p>
                    </div>
                    <div class="flex items-center text-sm text-blue-500">
                        <i class="fas fa-edit mr-2"></i>
                        <span>Form Edit Balita - Kelurahan</span>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="kartu_keluarga_id" id="kartu_keluarga_id" class="form-input" required>
                                ...
                                @foreach ($kartuKeluargas as $kk)
                                    <option value="{{ $kk->id }}" data-source="{{ $kk->source }}" {{ old('kartu_keluarga_id', $balita->kartu_keluarga_id) == $kk->id ? 'selected' : '' }}>
                ...
                <div class="mb-8">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" name="nik" id="nik" value="{{ old('nik', $balita->nik) }}" class="form-input" placeholder="Masukkan NIK balita">
                            @error('nik')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" id="nama" value="{{ old('nama', $balita->nama) }}" class="form-input" placeholder="Masukkan nama lengkap balita" required>
                            @error('nama')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="tanggal_lahir" id="tanggal_lahir" value="{{ old('tanggal_lahir', $tanggalLahir) }}" class="form-input" required>
                            @error('tanggal_lahir')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.1" name="berat" id="berat" value="{{ old('berat', $beratTinggi[0]) }}" class="form-input" placeholder="0.0" required>
                            @error('berat')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.1" name="tinggi" id="tinggi" value="{{ old('tinggi', $beratTinggi[1]) }}" class="form-input" placeholder="0.0" required>
                            @error('tinggi')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.1" name="lingkar_kepala" id="lingkar_kepala" value="{{ old('lingkar_kepala', $balita->lingkar_kepala) }}" class="form-input" placeholder="0.0">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.1" name="lingkar_lengan" id="lingkar_lengan" value="{{ old('lingkar_lengan', $balita->lingkar_lengan) }}" class="form-input" placeholder="0.0">
                ...
                <div class="mb-8">
                    ...
                    <div class="form-grid">
                        <div class="form-group md:col-span-2">
                            ...
                            <textarea name="alamat" id="alamat" class="form-input" rows="3" placeholder="Masukkan alamat lengkap">{{ old('alamat', $balita->alamat) }}</textarea>
                            @error('alamat')
                                <div class="error-message">
                                    <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="warna_label" id="warna_label" class="form-input" required>
                                <option value="Sehat" {{ old('warna_label', $balita->warna_label) == 'Sehat' ? 'selected' : '' }}>
                                    <span class="warna-label sehat"></span> Sehat
                                </option>
                                <option value="Waspada" {{ old('warna_label', $balita->warna_label) == 'Waspada' ? 'selected' : '' }}>
                                    <span class="warna-label waspada"></span> Waspada
                                </option>
                                <option value="Bahaya" {{ old('warna_label', $balita->warna_label) == 'Bahaya' ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="status_pemantauan" id="status_pemantauan" value="{{ old('status_pemantauan', $balita->status_pemantauan) }}" class="form-input" placeholder="Status pemantauan">
                ...
                <div class="mb-8">
                    ...
                    <div class="form-group">
                        <div class="flex items-center mb-4">
                            ...
                            <div>
                                <h5 class="font-medium text-gray-800">Foto Saat Ini</h5>
                                <p class="text-sm text-gray-600">Ganti foto jika diperlukan</p>
                            </div>
                        </div>
                        ...
                        @if ($balita->foto)
                            <div class="flex items-start gap-6">
                                <div>
                                    <img src="{{ Storage::url($balita->foto) }}" alt="Foto Balita" class="current-photo h-32">
                                    <p class="text-sm text-gray-500">Foto saat ini</p>
                                </div>
                                <div class="flex-1">
                                    <div class="photo-upload-area" id="photoUploadArea">
                                        <i class="fas fa-cloud-upload-alt"></i>
                                        <p class="text-gray-600">Klik untuk memilih foto baru atau seret dan lepas di sini</p>
                ...
                <div class="flex justify-between pt-6 border-t border-gray-200">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Perbarui Data Balita
                    </button>
                </div>
            </div>
        </form>
