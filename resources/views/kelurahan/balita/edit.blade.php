...
<head>
    ...
    <title>Edit Balita - Panel Kelurahan</title>
...
<body class="bg-gray-50 font-sans">
    ...
    <div class="ml-64 min-h-screen">
            ...
            <div class="px-8 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Perbarui data balita dalam sistem kelurahan</p>
                    </div>
        ...
        <div class="p-8">
            ...
            <form id="editBalitaForm" action="{{ route('kelurahan.balita.update', $balita->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="lingkar_kepala" id="lingkar_kepala" value="{{ old('lingkar_kepala', $balita->lingkar_kepala) }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-green-500 focus:ring-green-500 p-3 input-with-icon"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="lingkar_lengan" id="lingkar_lengan" value="{{ old('lingkar_lengan', $balita->lingkar_lengan) }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-green-500 focus:ring-green-500 p-3 input-with-icon"
                                           step="0.1" placeholder="0.0">
                                    <div class="input-icon">
                                        <i class="fas fa-circle-nodes"></i>
                                ...
                                @if ($balita->foto)
                                    <div class="mb-3">
                                        ...
                                        <div class="relative inline-block">
                                            <img src="{{ Storage::url($balita->foto) }}" alt="Foto Balita" class="h-32 w-32 object-cover rounded-lg shadow-md">
                                            <div class="absolute top-2 right-2">
                                                <span class="status-badge status-sehat">
                                    ...
                                    <p class="text-sm text-gray-600 mb-2">Ganti foto (jika perlu):</p>
                                @endif
                                <div class="relative">
