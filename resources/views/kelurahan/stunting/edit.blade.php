...
<body class="bg-gray-50 font-sans">
    ...
    <div class="ml-64 min-h-screen">
        ...
        <div class="p-8">
            ...
            @else
                <form action="{{ route('kelurahan.stunting.update', $stunting->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="form-section-body">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="text" name="nik" id="nik" value="{{ old('nik', $stunting->nik) }}" 
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="text" name="nama" id="nama" value="{{ old('nama', $stunting->nama) }}" 
                                               class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-10"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="date" name="tanggal_lahir" id="tanggal_lahir" value="{{ old('tanggal_lahir', $tanggalLahir) }}" 
                                               class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-10"
                                               required>
                                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        ...
                        <div class="form-section-body">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="number" name="berat" id="berat" value="{{ old('berat', $beratTinggi[0]) }}" 
                                               class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-10"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="number" name="tinggi" id="tinggi" value="{{ old('tinggi', $beratTinggi[1]) }}" 
                                               class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-10"
                                               step="0.1" placeholder="0.0" required>
                                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    ...
                    <div class="form-section card-hover">
                        <div class="form-section-header">
                            ...
                            <p class="text-sm text-gray-600 mt-1">Perbarui status gizi dan rencana tindak lanjut</p>
                        </div>
                        <div class="form-section-body">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="text" name="tindak_lanjut" id="tindak_lanjut" value="{{ old('tindak_lanjut', $stunting->tindak_lanjut) }}" 
                                               class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 pl-10"
                                ...
                                @if ($stunting->foto)
                                    <div class="current-photo">
                                        ...
                                        <div class="flex items-center space-x-4">
                                            <img src="{{ Storage::url($stunting->foto) }}" alt="Foto Stunting" class="w-20 h-20 object-cover rounded-lg border">
                                            <div>
                                                <p class="text-sm text-gray-600">File: {{ basename($stunting->foto) }}</p>
