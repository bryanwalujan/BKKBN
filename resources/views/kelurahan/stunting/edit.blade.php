...
<head>
    ...
    <title>Edit Data Stunting - CSSR Kelurahan</title>
...
<body class="bg-gray-50">
    ...
    <div class="ml-64 p-6 fade-in">
        ...
        @else
            <form action="{{ route('kelurahan.stunting.update', [$stunting->id, $source]) }}" method="POST" enctype="multipart/form-data" id="stuntingForm">
                @csrf
                @method('PUT')
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm mb-8 card-hover">
                    <div class="flex justify-between items-center mb-6">
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800">Edit Data Stunting</h3>
                            <p class="text-gray-600 text-sm mt-1">Perbarui informasi lengkap data stunting</p>
                        </div>
                        <div class="flex items-center text-sm text-blue-500">
                            <i class="fas fa-edit mr-2"></i>
                            <span>Form Edit Stunting - Kelurahan</span>
                        </div>
                    </div>
                    ...
                    <div class="info-box">
                        <p>
                            ...
                            Pastikan data yang diperbarui akurat dan lengkap untuk pemantauan stunting yang optimal.
                        </p>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="kartu_keluarga_id" id="kartu_keluarga_id" class="form-input" required>
                                    ...
                                    @foreach ($kartuKeluargas as $kk)
                                        <option value="{{ $kk->id }}" {{ old('kartu_keluarga_id', $stunting->kartu_keluarga_id) == $kk->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-8">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="text" name="nik" id="nik" value="{{ old('nik', $stunting->nik) }}" class="form-input" placeholder="Masukkan NIK">
                                @error('nik')
                                    <div class="error-message">
                                        <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama" id="nama" value="{{ old('nama', $stunting->nama) }}" class="form-input" placeholder="Masukkan nama lengkap" required>
                                @error('nama')
                                    <div class="error-message">
                                        <i class="fas fa-exclamation-circle"></i> {{ $message }}
                                    </div>
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <select name="warna_gizi" id="warna_gizi" class="form-input" required>
                                    <option value="Sehat" {{ old('warna_gizi', $stunting->warna_gizi) == 'Sehat' ? 'selected' : '' }}>
                                        <span class="warna-label sehat"></span> Sehat
                                    </option>
                                    <option value="Waspada" {{ old('warna_gizi', $stunting->warna_gizi) == 'Waspada' ? 'selected' : '' }}>
                                        <span class="warna-label waspada"></span> Waspada
                                    </option>
                                    <option value="Bahaya" {{ old('warna_gizi', $stunting->warna_gizi) == 'Bahaya' ? 'selected' : '' }}>
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <select name="warna_tindak_lanjut" id="warna_tindak_lanjut" class="form-input" required>
                                    <option value="Sehat" {{ old('warna_tindak_lanjut', $stunting->warna_tindak_lanjut) == 'Sehat' ? 'selected' : '' }}>
                                        <span class="warna-label sehat"></span> Sehat
                                    </option>
                                    <option value="Waspada" {{ old('warna_tindak_lanjut', $stunting->warna_tindak_lanjut) == 'Waspada' ? 'selected' : '' }}>
                                        <span class="warna-label waspada"></span> Waspada
                                    </option>
                                    <option value="Bahaya" {{ old('warna_tindak_lanjut', $stunting->warna_tindak_lanjut) == 'Bahaya' ? 'selected' : '' }}>
                                        <span class="warna-label bahaya"></span> Bahaya
                                    </option>
                                </select>
                            ...
                            <div class="photo-container">
                                @if ($stunting->foto)
                                    <div>
                                        ...
                                        <img src="{{ Storage::url($stunting->foto) }}" alt="Foto Stunting" class="current-photo">
                                    </div>
                                @else
                                    <div>
                    ...
                    <div class="flex justify-between pt-6 border-t border-gray-200">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save"></i> Perbarui Data Stunting
                        </button>
                    </div>
                </div>
            </form>
