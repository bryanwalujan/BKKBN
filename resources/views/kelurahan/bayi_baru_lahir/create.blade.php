...
<html>
<head>
    <title>Tambah Data Bayi Baru Lahir</title>
...
<body class="bg-gray-100">
    ...
    <div class="ml-64 p-6">
        <h2 class="text-2xl font-semibold mb-4">Tambah Data Bayi Baru Lahir</h2>
        @if (session('error'))
        ...
        @else
            <form id="createBayiBaruLahirForm" action="{{ route('kelurahan.bayi_baru_lahir.store') }}" method="POST" class="bg-white p-6 rounded shadow">
                @csrf
                <div class="mb-4">
                    ...
                    <select name="ibu_nifas_id" id="ibu_nifas_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
                        ...
                        @foreach ($ibuNifas as $ibu)
                            <option value="{{ $ibu->id }}" {{ old('ibu_nifas_id') == $ibu->id ? 'selected' : '' }}>{{ $ibu->ibu->nama }} ({{ $ibu->ibu->nik ?? '-' }})</option>
                        @endforeach
                    </select>
                    @error('ibu_nifas_id')
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="umur_dalam_kandungan" id="umur_dalam_kandungan" value="{{ old('umur_dalam_kandungan') }}" maxlength="255" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="berat_badan_lahir" id="berat_badan_lahir" value="{{ old('berat_badan_lahir') }}" maxlength="255" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="panjang_badan_lahir" id="panjang_badan_lahir" value="{{ old('panjang_badan_lahir') }}" maxlength="255" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
