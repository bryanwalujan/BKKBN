...
<head>
    ...
    <title>Data Bayi Baru Lahir - Admin Kelurahan</title>
            ...
            <div class="px-8 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Manajemen data bayi baru lahir di wilayah kelurahan Anda</p>
                    </div>
        ...
        <div class="p-8">
            ...
            <div class="bg-white rounded-xl shadow-sm border p-6 mb-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    @if ($search)
                        <a href="{{ route('kelurahan.bayi_baru_lahir.index') }}" class="text-sm text-gray-600 hover:text-gray-800 flex items-center">
                ...
                <form action="{{ route('kelurahan.bayi_baru_lahir.index') }}" method="GET" class="flex gap-4">
                    <div class="flex-grow">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center space-x-2">
                                            <a href="{{ route('kelurahan.bayi_baru_lahir.edit', $bayi->id) }}" 
                                            ...
                                            <button type="button" 
                                                    ...
                                                    title="Hapus"
                                                    data-url="{{ route('kelurahan.bayi_baru_lahir.destroy', $bayi->id) }}"
                                                    data-name="{{ $bayi->ibuNifas->ibu->nama ?? 'Bayi' }}">
                                                <i class="fas fa-trash"></i>
                                            </button>
                                            <button type="button" 
                                                    class="text-blue-600 hover:text-blue-900 transition-colors p-2 rounded-lg hover:bg-blue-50 action-btn move-to-balita-btn"
                                                    title="Tambah ke Balita"
                                                    data-url="{{ route('kelurahan.bayi_baru_lahir.moveToBalita', $bayi->id) }}"
                                                    data-name="{{ $bayi->ibuNifas->ibu->nama ?? 'Bayi' }}">
