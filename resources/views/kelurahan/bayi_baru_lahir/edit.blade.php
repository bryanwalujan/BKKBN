                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <div class="input-with-icon">
                                        <input type="text" name="umur_dalam_kandungan" id="umur_dalam_kandungan" 
                                               value="{{ old('umur_dalam_kandungan', $bayiBaruLahir->umur_dalam_kandungan) }}" 
                                               maxlength="255" 
                                ...
                                <div>
                                    ...
                                    <div class="input-with-icon">
                                        <input type="text" name="berat_badan_lahir" id="berat_badan_lahir" 
                                               value="{{ old('berat_badan_lahir', $bayiBaruLahir->berat_badan_lahir) }}" 
                                               maxlength="255" 
                                               class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                ...
                                <div>
                                    ...
                                    <div class="input-with-icon">
                                        <input type="text" name="panjang_badan_lahir" id="panjang_badan_lahir" 
                                               value="{{ old('panjang_badan_lahir', $bayiBaruLahir->panjang_badan_lahir) }}" 
                                               maxlength="255" 
                                               class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
