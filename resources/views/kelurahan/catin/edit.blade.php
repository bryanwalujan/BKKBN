...
<body class="bg-gray-50 font-sans">
    ...
    <div class="ml-64 min-h-screen">
            ...
            <div class="px-8 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Perbarui data calon pengantin yang sudah ada dalam sistem</p>
                    </div>
        ...
        <div class="p-8">
            ...
            <form action="{{ route('kelurahan.catin.update', $catin->id) }}" method="POST" id="catinForm">
                @csrf
                @method('PUT')
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="date" name="hari_tanggal" id="hari_tanggal" 
                                           value="{{ old('hari_tanggal', $catin->hari_tanggal ? $catin->hari_tanggal->format('Y-m-d') : '') }}" 
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        <h2 class="text-lg font-semibold text-gray-800 flex items-center">
                            ...
                            Biodata Catin Wanita
                            <span class="form-badge badge-woman">
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="text" name="catin_wanita_nama" id="catin_wanita_nama" 
                                           value="{{ old('catin_wanita_nama', $catin->catin_wanita_nama) }}" 
                                           maxlength="255" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="text" name="catin_wanita_nik" id="catin_wanita_nik" 
                                           value="{{ old('catin_wanita_nik', $catin->catin_wanita_nik) }}" 
                                           maxlength="16" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="text" name="catin_wanita_tempat_lahir" id="catin_wanita_tempat_lahir" 
                                           value="{{ old('catin_wanita_tempat_lahir', $catin->catin_wanita_tempat_lahir) }}" 
                                           maxlength="255" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="date" name="catin_wanita_tgl_lahir" id="catin_wanita_tgl_lahir" 
                                           value="{{ old('catin_wanita_tgl_lahir', $catin->catin_wanita_tgl_lahir ? $catin->catin_wanita_tgl_lahir->format('Y-m-d') : '') }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                           required>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="text" name="catin_wanita_no_hp" id="catin_wanita_no_hp" 
                                           value="{{ old('catin_wanita_no_hp', $catin->catin_wanita_no_hp) }}" 
                                           maxlength="15" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <textarea name="catin_wanita_alamat" id="catin_wanita_alamat" rows="3"
                                              class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                              placeholder="Masukkan alamat lengkap" required>{{ old('catin_wanita_alamat', $catin->catin_wanita_alamat) }}</textarea>
                                </div>
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        <h2 class="text-lg font-semibold text-gray-800 flex items-center">
                            ...
                            Biodata Catin Pria
                            <span class="form-badge badge-man">
                                <i class="fas fa-user-circle mr-1"></i>
                                Pria
                            </span>
                        </h2>
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="text" name="catin_pria_nama" id="catin_pria_nama" 
                                           value="{{ old('catin_pria_nama', $catin->catin_pria_nama) }}" 
                                           maxlength="255" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                           placeholder="Masukkan nama lengkap" required>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="text" name="catin_pria_nik" id="catin_pria_nik" 
                                           value="{{ old('catin_pria_nik', $catin->catin_pria_nik) }}" 
                                           maxlength="16" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                           placeholder="Masukkan 16 digit NIK" required inputmode="numeric">
                                </div>
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="text" name="catin_pria_tempat_lahir" id="catin_pria_tempat_lahir" 
                                           value="{{ old('catin_pria_tempat_lahir', $catin->catin_pria_tempat_lahir) }}" 
                                           maxlength="255" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                           placeholder="Masukkan tempat lahir" required>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="date" name="catin_pria_tgl_lahir" id="catin_pria_tgl_lahir" 
                                           value="{{ old('catin_pria_tgl_lahir', $catin->catin_pria_tgl_lahir ? $catin->catin_pria_tgl_lahir->format('Y-m-d') : '') }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                           required>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="text" name="catin_pria_no_hp" id="catin_pria_no_hp" 
                                           value="{{ old('catin_pria_no_hp', $catin->catin_pria_no_hp) }}" 
                                           maxlength="15" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                           placeholder="Masukkan nomor HP" required>
                                </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <textarea name="catin_pria_alamat" id="catin_pria_alamat" rows="3"
                                              class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                              placeholder="Masukkan alamat lengkap" required>{{ old('catin_pria_alamat', $catin->catin_pria_alamat) }}</textarea>
                                </div>
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        <h2 class="text-lg font-semibold text-gray-800 flex items-center">
                            ...
                            Hasil Pemeriksaan Catin Wanita
                            <span class="form-badge badge-medical">
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="date" name="tanggal_pernikahan" id="tanggal_pernikahan" 
                                           value="{{ old('tanggal_pernikahan', $catin->tanggal_pernikahan ? $catin->tanggal_pernikahan->format('Y-m-d') : '') }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3">
                                </div>
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="number" name="berat_badan" id="berat_badan" 
                                           value="{{ old('berat_badan', $catin->berat_badan) }}" 
                                           step="0.1" min="0" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                           placeholder="0.0">
                                </div>
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="number" name="tinggi_badan" id="tinggi_badan" 
                                           value="{{ old('tinggi_badan', $catin->tinggi_badan) }}" 
                                           step="0.1" min="0" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                           placeholder="0.0">
                                </div>
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="number" name="kadar_hb" id="kadar_hb" 
                                           value="{{ old('kadar_hb', $catin->kadar_hb) }}" 
                                           step="0.1" min="0" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                           placeholder="0.0">
                                </div>
    ...
    <script>
        ...
        document.getElementById('catinForm').addEventListener('submit', function(e) {
            ...
            Swal.fire({
                title: 'Konfirmasi',
                text: 'Apakah Anda yakin ingin memperbarui data calon pengantin ini?',
                icon: 'question',
