...
<body class="bg-gray-50 font-sans">
    ...
    <div class="ml-64 min-h-screen">
            ...
            <div class="px-8 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Tambah data calon pengantin baru ke dalam sistem</p>
                    </div>
        ...
        <div class="p-8">
            ...
            <form action="{{ route('kelurahan.catin.store') }}" method="POST" id="catinForm">
                @csrf
                
                <!-- Progress Bar -->
                <div class="mb-8">
                    <div class="flex justify-between mb-2">
                        <span class="text-sm font-medium text-gray-700">Proses Pengisian Form</span>
                        <span class="text-sm font-medium text-gray-700" id="progressPercentage">0%</span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-2.5">
                        <div class="progress-bar h-2.5 rounded-full" id="progressBar"></div>
                    </div>
                </div>
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Masukkan tanggal pencatatan data</p>
                    </div>
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Masukkan data lengkap calon pengantin wanita</p>
                    </div>
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="text" name="catin_wanita_nama" id="catin_wanita_nama" value="{{ old('catin_wanita_nama') }}" maxlength="255" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="text" name="catin_wanita_nik" id="catin_wanita_nik" value="{{ old('catin_wanita_nik') }}" maxlength="16" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="text" name="catin_wanita_tempat_lahir" id="catin_wanita_tempat_lahir" value="{{ old('catin_wanita_tempat_lahir') }}" maxlength="255" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    <i class="fas fa-calendar"></i>
                                    <input type="date" name="catin_wanita_tgl_lahir" id="catin_wanita_tgl_lahir" value="{{ old('catin_wanita_tgl_lahir') }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                           required>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="text" name="catin_wanita_no_hp" id="catin_wanita_no_hp" value="{{ old('catin_wanita_no_hp') }}" maxlength="15" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <textarea name="catin_wanita_alamat" id="catin_wanita_alamat" rows="3"
                                              class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                              placeholder="Masukkan alamat lengkap" required>{{ old('catin_wanita_alamat') }}</textarea>
                                </div>
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Masukkan data lengkap calon pengantin pria</p>
                    </div>
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="input-with-icon">
                                    <i class="fas fa-signature"></i>
                                    <input type="text" name="catin_pria_nama" id="catin_pria_nama" value="{{ old('catin_pria_nama') }}" maxlength="255" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                           placeholder="Masukkan nama lengkap" required>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    <i class="fas fa-id-card"></i>
                                    <input type="text" name="catin_pria_nik" id="catin_pria_nik" value="{{ old('catin_pria_nik') }}" maxlength="16" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                           placeholder="Masukkan 16 digit NIK" required inputmode="numeric">
                                </div>
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    <i class="fas fa-city"></i>
                                    <input type="text" name="catin_pria_tempat_lahir" id="catin_pria_tempat_lahir" value="{{ old('catin_pria_tempat_lahir') }}" maxlength="255" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                           placeholder="Masukkan tempat lahir" required>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    <i class="fas fa-calendar"></i>
                                    <input type="date" name="catin_pria_tgl_lahir" id="catin_pria_tgl_lahir" value="{{ old('catin_pria_tgl_lahir') }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                           required>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    <i class="fas fa-mobile-alt"></i>
                                    <input type="text" name="catin_pria_no_hp" id="catin_pria_no_hp" value="{{ old('catin_pria_no_hp') }}" maxlength="15" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                           placeholder="Masukkan nomor HP" required>
                                </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <textarea name="catin_pria_alamat" id="catin_pria_alamat" rows="3"
                                              class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                              placeholder="Masukkan alamat lengkap" required>{{ old('catin_pria_alamat') }}</textarea>
                                </div>
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Masukkan hasil pemeriksaan kesehatan calon pengantin wanita</p>
                    </div>
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="input-with-icon">
                                    <i class="fas fa-calendar"></i>
                                    <input type="date" name="tanggal_pernikahan" id="tanggal_pernikahan" value="{{ old('tanggal_pernikahan') }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3">
                                </div>
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="number" name="berat_badan" id="berat_badan" value="{{ old('berat_badan') }}" step="0.1" min="0" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                           placeholder="0.0">
                                </div>
                                @error('berat_badan')
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="number" name="tinggi_badan" id="tinggi_badan" value="{{ old('tinggi_badan') }}" step="0.1" min="0" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                           placeholder="0.0">
                                </div>
                                @error('tinggi_badan')
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="number" name="imt" id="imt" value="{{ old('imt') }}" step="0.1" min="0" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                           placeholder="0.0">
                                </div>
                                @error('imt')
                            ...
                            <div>
                                ...
                                <div class="input-with-icon">
                                    ...
                                    <input type="number" name="kadar_hb" id="kadar_hb" value="{{ old('kadar_hb') }}" step="0.1" min="0" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3"
                                           placeholder="0.0">
                                </div>
                                @error('kadar_hb')
    ...
    <script>
        ...
        function calculateProgress() {
            const form = document.getElementById('catinForm');
        ...
        document.getElementById('catinForm').addEventListener('submit', function(e) {
            const form = this;
            e.preventDefault();
            
            Swal.fire({
                title: 'Konfirmasi',
                text: 'Apakah Anda yakin ingin menyimpan data calon pengantin ini?',
                icon: 'question',
