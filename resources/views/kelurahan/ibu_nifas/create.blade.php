...
<head>
    ...
    <title>Tambah Data Ibu Nifas - CSSR Kelurahan</title>
...
<body class="bg-gray-50">
    ...
    <div class="ml-64 p-6 fade-in">
        ...
        <div class="mb-8">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-gray-600">Tambah data kesehatan ibu nifas ke dalam sistem CSSR</p>
        ...
        <form action="{{ route('kelurahan.ibu_nifas.store') }}" method="POST" id="nifasForm">
            @csrf
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm mb-8 card-hover">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p class="text-gray-600 text-sm mt-1">Isi informasi kesehatan ibu nifas</p>
                    </div>
                    <div class="flex items-center text-sm text-blue-500">
                        <i class="fas fa-baby mr-2"></i>
                        <span>Form Tambah Ibu Nifas - Kelurahan</span>
                    </div>
                </div>
                ...
                <div class="info-box">
                    <p>
                        ...
                        Data ibu nifas digunakan untuk pemantauan kesehatan ibu setelah melahirkan (periode 42 hari).
                    </p>
                </div>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <select name="ibu_id" id="ibu_id" class="form-input" required>
                                ...
                                @foreach ($ibus as $ibu)
                                    <option value="{{ $ibu->id }}" data-source="verified" {{ old('ibu_id') == $ibu->id ? 'selected' : '' }}>
                                        {{ $ibu->nama }} ({{ $ibu->nik ?? '-' }}) 
                                ...
                                @foreach ($pendingIbus as $ibu)
                                    <option value="{{ $ibu->id }}" data-source="pending" {{ old('ibu_id') == $ibu->id ? 'selected' : '' }}>
                                        {{ $ibu->nama }} ({{ $ibu->nik ?? '-' }}) 
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="number" name="hari_nifas" id="hari_nifas" value="{{ old('hari_nifas') }}" min="0" max="42" class="form-input" placeholder="Masukkan hari ke-nifas" required>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="health-status">
                                <div class="health-option normal" data-value="Normal">
                                    <i class="fas fa-smile"></i>
                                    <div>Normal</div>
                                </div>
                                <div class="health-option attention" data-value="Butuh Perhatian">
                                    <i class="fas fa-meh"></i>
                                    <div>Butuh Perhatian</div>
                                </div>
                                <div class="health-option critical" data-value="Kritis">
                                    <i class="fas fa-frown"></i>
                                    <div>Kritis</div>
                                </div>
                            </div>
                            <input type="hidden" name="kondisi_kesehatan" id="kondisi_kesehatan" value="{{ old('kondisi_kesehatan') }}" required>
                ...
                <div class="flex justify-between pt-6 border-t border-gray-200">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Simpan Data Ibu Nifas
                    </button>
                </div>
            </div>
        </form>
    ...
    <script>
        $(document).ready(function() {
            ...
            // Set initial health status if exists
            var initialKondisi = '{{ old('kondisi_kesehatan') }}';
            if (initialKondisi) {
                $('.health-option[data-value="' + initialKondisi + '"]').addClass('selected');
            }
