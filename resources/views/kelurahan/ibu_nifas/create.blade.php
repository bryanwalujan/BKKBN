...
<head>
    ...
    <title>Tambah Data Ibu Nifas - Admin Kelurahan</title>
...
<body class="bg-gray-50 font-sans">
    ...
    <div class="ml-64 min-h-screen">
        ...
        <div class="p-8">
                ...
                <div class="mb-6 p-4 bg-red-50 border border-red-200 rounded-xl flex items-center">
                    ...
                    <div>
                        <p class="text-red-800 font-medium">
                            Tidak ada data ibu dengan status Nifas. Silakan tambahkan 
                            <a href="{{ route('kelurahan.ibu.create') }}" class="text-blue-600 hover:underline font-medium">
                                data ibu
                            </a> 
                            terlebih dahulu.
                        </p>
            ...
            @else
                <form id="createIbuNifasForm" action="{{ route('kelurahan.ibu_nifas.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
