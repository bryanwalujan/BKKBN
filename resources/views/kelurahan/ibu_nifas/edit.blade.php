...
<head>
    ...
    <title>Edit Data Ibu Nifas - Admin Kelurahan</title>
...
<body class="bg-gray-50 font-sans">
    ...
    <div class="ml-64 min-h-screen">
            ...
            <div class="px-8 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Perbarui data ibu nifas dalam sistem</p>
                    </div>
        ...
        <div class="p-8">
            ...
            <form id="editIbuNifasForm" action="{{ route('kelurahan.ibu_nifas.update', $ibuNifas->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Pilih data ibu yang akan diperbarui dalam sistem nifas</p>
                    </div>
                    <div class="form-section-body">
                        <div>
                            ...
                            <select name="ibu_id" id="ibu_id" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3" required>
                                ...
                                @foreach ($ibus as $ibu)
                                    <option value="{{ $ibu->id }}" {{ old('ibu_id', $ibuNifas->ibu_id) == $ibu->id ? 'selected' : '' }}>
                                        {{ $ibu->nama }} ({{ $ibu->nik ?? '-' }})
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Perbarui detail persalinan dan kondisi ibu</p>
                    </div>
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="hari_nifas" id="hari_nifas" value="{{ old('hari_nifas', $ibuNifas->hari_nifas) }}" 
                                           min="0" max="42" step="1"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="date" name="tanggal_melahirkan" id="tanggal_melahirkan" 
                                           value="{{ old('tanggal_melahirkan', $ibuNifas->tanggal_melahirkan instanceof \Carbon\Carbon ? $ibuNifas->tanggal_melahirkan->format('Y-m-d') : $ibuNifas->tanggal_melahirkan) }}" 
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 input-with-icon">
                                    <div class="input-icon">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="tempat_persalinan" id="tempat_persalinan" value="{{ old('tempat_persalinan', $ibuNifas->tempat_persalinan) }}" 
                                           maxlength="255"
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 input-with-icon"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="penolong_persalinan" id="penolong_persalinan" value="{{ old('penolong_persalinan', $ibuNifas->penolong_persalinan) }}" 
                                           maxlength="255"
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 input-with-icon"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="cara_persalinan" id="cara_persalinan" value="{{ old('cara_persalinan', $ibuNifas->cara_persalinan) }}" 
                                           maxlength="255"
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 input-with-icon"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="komplikasi" id="komplikasi" value="{{ old('komplikasi', $ibuNifas->komplikasi) }}" 
                                           maxlength="255"
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 input-with-icon"
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Perbarui data kesehatan dan pemantauan ibu nifas</p>
                    </div>
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="kb_pasca_salin" id="kb_pasca_salin" value="{{ old('kb_pasca_salin', $ibuNifas->kb_pasca_salin) }}" 
                                           maxlength="255"
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 input-with-icon"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="berat" id="berat" value="{{ old('berat', $ibuNifas->berat) }}" 
                                           step="0.1" min="0"
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 input-with-icon"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="tinggi" id="tinggi" value="{{ old('tinggi', $ibuNifas->tinggi) }}" 
                                           step="0.1" min="0"
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 input-with-icon"
                                           placeholder="0.0" required>
                                    <div class="input-icon">
                ...
                <div class="form-section card-hover">
                    <div class="form-section-header">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Perbarui data bayi yang baru lahir</p>
                    </div>
                    <div class="form-section-body">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="keadaan_bayi" id="keadaan_bayi" value="{{ old('keadaan_bayi', $ibuNifas->keadaan_bayi) }}" 
                                           maxlength="255"
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 input-with-icon"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="bayi[umur_dalam_kandungan]" id="bayi_umur_dalam_kandungan" value="{{ old('bayi.umur_dalam_kandungan', $ibuNifas->bayiBaruLahir->umur_dalam_kandungan ?? '') }}" 
                                           maxlength="255"
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 input-with-icon"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="bayi[berat_badan_lahir]" id="bayi_berat_badan_lahir" value="{{ old('bayi.berat_badan_lahir', $ibuNifas->bayiBaruLahir->berat_badan_lahir ?? '') }}" 
                                           maxlength="255"
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 input-with-icon"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="bayi[panjang_badan_lahir]" id="bayi_panjang_badan_lahir" value="{{ old('bayi.panjang_badan_lahir', $ibuNifas->bayiBaruLahir->panjang_badan_lahir ?? '') }}" 
                                           maxlength="255"
                                           class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 p-3 input-with-icon"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#editIbuNifasForm').on('submit', function(e) {
                e.preventDefault();
                const form = $(this);
                Swal.fire({
                    title: 'Perbarui Data?',
                    text: 'Apakah Anda yakin ingin memperbarui data ibu nifas ini?',
                    icon: 'question',
                        ...
                        $.ajax({
                            ...
                            success: function() {
                                Swal.fire({
                                    icon: 'success',
                                    title: 'Berhasil',
                                    text: 'Data ibu nifas berhasil diperbarui.',
                                    confirmButtonColor: '#3b82f6',
                                }).then(() => {
