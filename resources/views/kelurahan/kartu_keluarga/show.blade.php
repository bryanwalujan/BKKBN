    ...
    <div class="ml-64 p-6">
        ...
        <div class="flex justify-between mb-4">
            ...
            @if ($kartuKeluarga->source === 'pending')
                <div>
                    <a href="{{ route('kelurahan.kartu_keluarga.edit', [$kartuKeluarga->id, 'pending']) }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Edit</a>
                    <button type="button" class="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600 ml-2" onclick="showDeleteModal('{{ route('kelurahan.kartu_keluarga.destroy', $kartuKeluarga->id) }}', '{{ $kartuKeluarga->kepala_keluarga }}')">Hapus</button>
                </div>
            @else
                <a href="{{ route('kelurahan.kartu_keluarga.edit', [$kartuKeluarga->id, 'verified']) }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Edit</a>
            @endif
        </div>
        ...
        <div class="bg-white p-6 rounded shadow mb-6">
            ...
            <table class="w-full">
                ...
                @if ($kartuKeluarga->source === 'pending')
                    <tr class="border-b">
                        <td class="p-2 font-medium">Status Verifikasi</td>
                        <td class="p-2">{{ $kartuKeluarga->status_verifikasi }}</td>
                    </tr>
                    <tr class="border-b">
                        <td class="p-2 font-medium">Diupload Oleh</td>
                        <td class="p-2">{{ $kartuKeluarga->createdBy->name ?? 'Tidak diketahui' }}</td>
                    </tr>
                @endif
            </table>
        </div>
        ...
        @if ($kartuKeluarga->source === 'verified')
            ...
            <div class="bg-white p-6 rounded shadow mb-6">
                ...
                <a href="{{ route('kelurahan.ibu.create') }}?kartu_keluarga_id={{ $kartuKeluarga->id }}" class="mb-4 inline-block bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Tambah Ibu</a>
                        ...
                        <tbody>
                            @foreach ($kartuKeluarga->ibu as $index => $ibu)
                                <tr class="border-b hover:bg-gray-50">
                                    ...
                                    <td class="p-4">
                                        <a href="{{ route('kelurahan.ibu.edit', [$ibu->id, 'verified']) }}" class="text-blue-500 hover:underline">Edit</a>
                                        <button type="button" class="text-red-500 hover:underline ml-2" onclick="showDeleteModal('{{ route('kelurahan.ibu.destroy', $ibu->id) }}', '{{ $ibu->nama }}')">Hapus</button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
            ...
            <div class="bg-white p-6 rounded shadow mb-6">
                ...
                <a href="{{ route('kelurahan.balita.create') }}?kartu_keluarga_id={{ $kartuKeluarga->id }}" class="mb-4 inline-block bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Tambah Balita</a>
                        ...
                        <tbody>
                            @foreach ($kartuKeluarga->balitas as $index => $balita)
                                <tr class="border-b hover:bg-gray-50">
                                    ...
                                    <td class="p-4">{{ $balita->tanggal_lahir ? \Carbon\Carbon::parse($balita->tanggal_lahir)->format('d-m-Y') : '-' }}</td>
                                    ...
                                    <td class="p-4">
                                        <a href="{{ route('kelurahan.balita.edit', [$balita->id, 'verified']) }}" class="text-blue-500 hover:underline">Edit</a>
                                        <button type="button" class="text-red-500 hover:underline ml-2" onclick="showDeleteModal('{{ route('kelurahan.balita.destroy', $balita->id) }}', '{{ $balita->nama }}')">Hapus</button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
            ...
            <div class="bg-white p-6 rounded shadow mb-6">
                ...
                <a href="{{ route('kelurahan.remaja_putri.create') }}?kartu_keluarga_id={{ $kartuKeluarga->id }}" class="mb-4 inline-block bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Tambah Remaja Putri</a>
                        ...
                        <tbody>
                            @foreach ($kartuKeluarga->remajaPutris as $index => $remaja)
                                <tr class="border-b hover:bg-gray-50">
                                    ...
                                    <td class="p-4">
                                        <a href="{{ route('kelurahan.remaja_putri.edit', [$remaja->id, 'verified']) }}" class="text-blue-500 hover:underline">Edit</a>
                                        <button type="button" class="text-red-500 hover:underline ml-2" onclick="showDeleteModal('{{ route('kelurahan.remaja_putri.destroy', $remaja->id) }}', '{{ $remaja->nama }}')">Hapus</button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
            ...
            <div class="bg-white p-6 rounded shadow mb-6">
                ...
                <a href="{{ route('kelurahan.aksi_konvergensi.create') }}?kartu_keluarga_id={{ $kartuKeluarga->id }}" class="mb-4 inline-block bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Tambah Aksi Konvergensi</a>
                        ...
                        <tbody>
                            @foreach ($kartuKeluarga->aksiKonvergensis as $index => $aksi)
                                <tr class="border-b hover:bg-gray-50">
                                    ...
                                    <td class="p-4">{{ \Illuminate\Support\Str::limit($aksi->narasi, 50) }}</td>
                                    <td class="p-4">{{ $aksi->pelaku_aksi ?? '-' }}</td>
                                    <td class="p-4">{{ $aksi->waktu_pelaksanaan ? \Carbon\Carbon::parse($aksi->waktu_pelaksanaan)->format('d-m-Y H:i') : '-' }}</td>
                                    <td class="p-4">
                                        @if ($aksi->foto)
                                    ...
                                    <td class="p-4">
                                        <a href="{{ route('kelurahan.aksi_konvergensi.edit', [$aksi->id, 'verified']) }}" class="text-blue-500 hover:underline">Edit</a>
                                        <button type="button" class="text-red-500 hover:underline ml-2" onclick="showDeleteModal('{{ route('kelurahan.aksi_konvergensi.destroy', $aksi->id) }}', '{{ $aksi->nama_aksi }}')">Hapus</button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
            ...
            <div class="bg-white p-6 rounded shadow mb-6">
                ...
                <a href="{{ route('kelurahan.genting.create') }}?kartu_keluarga_id={{ $kartuKeluarga->id }}" class="mb-4 inline-block bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Tambah Kegiatan Genting</a>
                        ...
                        <tbody>
                            @foreach ($kartuKeluarga->gentings as $index => $genting)
                                <tr class="border-b hover:bg-gray-50">
                                    ...
                                    <td class="p-4">
                                        <a href="{{ route('kelurahan.genting.edit', [$genting->id, 'verified']) }}" class="text-blue-500 hover:underline">Edit</a>
                                        <button type="button" class="text-red-500 hover:underline ml-2" onclick="showDeleteModal('{{ route('kelurahan.genting.destroy', $genting->id) }}', '{{ $genting->nama_kegiatan }}')">Hapus</button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
