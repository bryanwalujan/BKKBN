...
<body class="bg-gray-50 font-sans">
    ...
    <div class="ml-64 min-h-screen">
            ...
            <div class="px-8 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Edit data kartu keluarga untuk wilayah kelurahan Anda</p>
                    </div>
        ...
        <div class="p-8">
            ...
            @else
                <form action="{{ route('kelurahan.kartu_keluarga.update', $kartuKeluarga->id) }}" method="POST" id="edit-form">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-section card-hover">
                        <div class="form-section-header">
                            ...
                            <p class="text-sm text-gray-600 mt-1">Edit informasi dasar kartu keluarga</p>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    <label for="kepala_keluarga" class="block text-sm font-medium text-gray-700 mb-2 flex items-center">
                                        <i class="fas fa-user text-purple-500 mr-2 text-xs"></i>
                                        Kepala Keluarga
                                    </label>
                                    <div class="relative">
                    ...
                    <div class="form-section card-hover">
                        <div class="form-section-header">
                            ...
                            <p class="text-sm text-gray-600 mt-1">Klik pada peta untuk mengubah koordinat lokasi rumah</p>
                        </div>
                        <div class="form-section-body">
                            <div class="mb-4">
                                <div id="map"></div>
