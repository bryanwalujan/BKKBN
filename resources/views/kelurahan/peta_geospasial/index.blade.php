        ...
        <div class="bg-white p-6 rounded-xl shadow-sm mb-8 card-hover">
            <div class="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p class="text-gray-600 text-sm mt-1">Saring data berdasarkan status kesehatan keluarga</p>
                </div>
            ...
            <form action="{{ route('kelurahan.peta_geospasial.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="bg-white rounded-xl shadow-sm overflow-hidden card-hover p-6">
            <div class="flex justify-between items-center mb-4">
                <div>
                    ...
                    <p class="text-gray-600 text-sm mt-1">Visualisasi lokasi keluarga berdasarkan koordinat GPS di wilayah {{ auth()->user()->kelurahan->nama_kelurahan }}</p>
                </div>
